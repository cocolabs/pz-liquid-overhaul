...
public class Matrix4x3d implements Externalizable, Matrix4x3dc {
   ...
   private Matrix4x3d mulGeneric(Matrix4x3dc var1, Matrix4x3d var2) {
      ...
      double var21 = this.m00 * var1.m30() + this.m10 * var1.m31() + this.m20 * var1.m32() + this.m30;
      double var23 = this.m01 * var1.m30() + this.m11 * var1.m31() + this.m21 * var1.m32() + this.m31;
      double var25 = this.m02 * var1.m30() + this.m12 * var1.m31() + this.m22 * var1.m32() + this.m32;
      var2.m00 = var3;
      var2.m01 = var5;
      var2.m02 = var7;
      var2.m10 = var9;
   ...
   private Matrix4x3d mulGeneric(Matrix4x3fc var1, Matrix4x3d var2) {
      ...
      double var21 = this.m00 * (double)var1.m30() + this.m10 * (double)var1.m31() + this.m20 * (double)var1.m32() + this.m30;
      double var23 = this.m01 * (double)var1.m30() + this.m11 * (double)var1.m31() + this.m21 * (double)var1.m32() + this.m31;
      double var25 = this.m02 * (double)var1.m30() + this.m12 * (double)var1.m31() + this.m22 * (double)var1.m32() + this.m32;
      var2.m00 = var3;
      var2.m01 = var5;
      var2.m02 = var7;
      var2.m10 = var9;
   ...
   public Matrix4x3d mulTranslation(Matrix4x3dc var1, Matrix4x3d var2) {
      ...
      double var9 = var1.m10();
      double var11 = var1.m11();
      double var13 = var1.m12();
      double var15 = var1.m20();
      double var17 = var1.m21();
      double var19 = var1.m22();
      double var21 = var1.m30() + this.m30;
      double var23 = var1.m31() + this.m31;
      double var25 = var1.m32() + this.m32;
      var2.m00 = var3;
      var2.m01 = var5;
      var2.m02 = var7;
      var2.m10 = var9;
   ...
   public Matrix4x3d mulTranslation(Matrix4x3fc var1, Matrix4x3d var2) {
      double var3 = (double)var1.m00();
      double var5 = (double)var1.m01();
      double var7 = (double)var1.m02();
      double var9 = (double)var1.m10();
      double var11 = (double)var1.m11();
      double var13 = (double)var1.m12();
      double var15 = (double)var1.m20();
      double var17 = (double)var1.m21();
      double var19 = (double)var1.m22();
      double var21 = (double)var1.m30() + this.m30;
      double var23 = (double)var1.m31() + this.m31;
      double var25 = (double)var1.m32() + this.m32;
      var2.m00 = var3;
      var2.m01 = var5;
      var2.m02 = var7;
      var2.m10 = var9;
   ...
   public Matrix4x3d fma(Matrix4x3fc var1, double var2, Matrix4x3d var4) {
      var4.m00 = this.m00 + (double)var1.m00() * var2;
      var4.m01 = this.m01 + (double)var1.m01() * var2;
      var4.m02 = this.m02 + (double)var1.m02() * var2;
      var4.m10 = this.m10 + (double)var1.m10() * var2;
      var4.m11 = this.m11 + (double)var1.m11() * var2;
      var4.m12 = this.m12 + (double)var1.m12() * var2;
      var4.m20 = this.m20 + (double)var1.m20() * var2;
      var4.m21 = this.m21 + (double)var1.m21() * var2;
      var4.m22 = this.m22 + (double)var1.m22() * var2;
      var4.m30 = this.m30 + (double)var1.m30() * var2;
      var4.m31 = this.m31 + (double)var1.m31() * var2;
      var4.m32 = this.m32 + (double)var1.m32() * var2;
      var4.properties = 0;
      return var4;
   }
   ...
   private Matrix4x3d invertGeneric(Matrix4x3d var1) {
      ...
      double var46 = (var22 - var4) * var2;
      double var48 = (var38 - var28) * var2;
      double var50 = (var8 - var26) * var2;
      double var52 = (var6 - var14) * var2;
      double var54 = (var30 - var34) * var2;
      double var56 = (var18 - var10) * var2;
      double var58 = (var4 * this.m31 - var6 * this.m32 + var14 * this.m32 - var12 * this.m30 + var20 * this.m30 - var22 * this.m31) * var2;
      double var60 = (var28 * this.m31 - var30 * this.m32 + var34 * this.m32 - var32 * this.m30 + var36 * this.m30 - var38 * this.m31) * var2;
      double var62 = (var16 * this.m30 - var24 * this.m30 + var26 * this.m31 - var8 * this.m31 + var10 * this.m32 - var18 * this.m32) * var2;
      var1.m00 = var40;
      var1.m01 = var42;
      var1.m02 = var44;
      var1.m10 = var46;
   ...
   public Matrix4x3d invertUnitScale(Matrix4x3d var1) {
   ...
   private Matrix4x3d translateGeneric(double var1, double var3, double var5, Matrix4x3d var7) {
      ...
      var7.properties = (byte)(this.properties & -5);
      return var7;
   }
   ...
   public Matrix4x3d rotateX(double var1, Matrix4x3d var3) {
      if ((this.properties & 4) != 0) {
         ...
         var3.m31 = this.m31;
         var3.m32 = this.m32;
         var3.properties = (byte)(this.properties & -13);
         return var3;
      }
   }
   ...
   public Matrix4x3d rotateLocal(Quaterniondc var1, Matrix4x3d var2) {
      ...
      double var59 = var23 * this.m30 + var29 * this.m31 + var35 * this.m32;
      double var61 = var25 * this.m30 + var31 * this.m31 + var37 * this.m32;
      double var63 = var27 * this.m30 + var33 * this.m31 + var39 * this.m32;
      var2.m00 = var41;
      var2.m01 = var43;
      var2.m02 = var45;
      var2.m10 = var47;
   ...
   public Matrix4x3d ortho(double var1, double var3, double var5, double var7, double var9, double var11, boolean var13, Matrix4x3d var14) {
      ...
      var14.properties = (byte)(this.properties & -13);
      return var14;
   }
   ...
   public Matrix4x3d orthoSymmetricLH(double var1, double var3, double var5, double var7, boolean var9, Matrix4x3d var10) {
      double var11 = 2.0D / var1;
      double var13 = 2.0D / var3;
      double var15 = (double)(var9 ? 1.0F : 2.0F) / (var7 - var5);
      double var17 = (var9 ? var5 : var7 + var5) / (var5 - var7);
      var10.m30 = this.m20 * var17 + this.m30;
      var10.m31 = this.m21 * var17 + this.m31;
      var10.m32 = this.m22 * var17 + this.m32;
   ...
   public Matrix4x3d lookAlong(double var1, double var3, double var5, double var7, double var9, double var11, Matrix4x3d var13) {
      if ((this.properties & 4) != 0) {
         ...
         var13.m31 = this.m31;
         var13.m32 = this.m32;
         var13.properties = (byte)(this.properties & -13);
         return var13;
      }
   }
   ...
   private Matrix4x3d lookAtGeneric(double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, double var17, Matrix4x3d var19) {
      ...
      var19.m11 = var74;
      var19.m12 = var76;
      var19.properties = (byte)(this.properties & -13);
      return var19;
   }
   ...
   public Matrix4x3d shadow(double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, Matrix4x3d var17) {
      ...
      var17.m21 = var76;
      var17.m22 = var78;
      var17.properties = (byte)(this.properties & -13);
      return var17;
   }
   ...
   public Matrix4x3d arcball(double var1, double var3, double var5, double var7, double var9, double var11, Matrix4x3d var13) {
      ...
      double var20 = Math.cos(var9);
      double var22 = Math.sin(var9);
      double var24 = this.m10 * var20 + this.m20 * var22;
      double var26 = this.m11 * var20 + this.m21 * var22;
      double var28 = this.m12 * var20 + this.m22 * var22;
      double var30 = this.m20 * var20 - this.m10 * var22;
      double var32 = this.m21 * var20 - this.m11 * var22;
      double var34 = this.m22 * var20 - this.m12 * var22;
      var20 = Math.cos(var11);
      var22 = Math.sin(var11);
      double var36 = this.m00 * var20 - var30 * var22;
      double var38 = this.m01 * var20 - var32 * var22;
      double var40 = this.m02 * var20 - var34 * var22;
      double var42 = this.m00 * var22 + var30 * var20;
      double var44 = this.m01 * var22 + var32 * var20;
      double var46 = this.m02 * var22 + var34 * var20;
   ...
   private final class Proxy implements Matrix4x3dc {
      ...
      public Matrix4x3d fma(Matrix4x3dc var1, double var2, Matrix4x3d var4) {
         return this.delegate.fma(var1, var2, var4);
      }
      ...
      public ByteBuffer getTransposedFloats(ByteBuffer var1) {
         return this.delegate.getTransposedFloats(var1);
      }

      public ByteBuffer getTransposedFloats(int var1, ByteBuffer var2) {
         return this.delegate.getTransposedFloats(var1, var2);
      }
