...
public class MatrixStackf extends Matrix4f {
   ...
   public MatrixStackf(int var1) {
      if (var1 < 1) {
         throw new IllegalArgumentException("stackSize must be >= 1");
      } else {
         this.mats = new Matrix4f[var1 - 1];

         for(int var2 = 0; var2 < this.mats.length; ++var2) {
            this.mats[var2] = new Matrix4f();
         }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         if (var1 instanceof MatrixStackf) {
            MatrixStackf var2 = (MatrixStackf)var1;
