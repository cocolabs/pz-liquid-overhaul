...
public class FrustumIntersection {
   ...
   public FrustumIntersection set(Matrix4fc var1) {
      ...
      float var2 = (float)(1.0D / Math.sqrt((double)(this.nxX * this.nxX + this.nxY * this.nxY + this.nxZ * this.nxZ)));
      this.nxX *= var2;
      this.nxY *= var2;
      this.nxZ *= var2;
      this.nxW *= var2;
      ...
      var2 = (float)(1.0D / Math.sqrt((double)(this.pxX * this.pxX + this.pxY * this.pxY + this.pxZ * this.pxZ)));
      this.pxX *= var2;
      this.pxY *= var2;
      this.pxZ *= var2;
      this.pxW *= var2;
      ...
      var2 = (float)(1.0D / Math.sqrt((double)(this.nyX * this.nyX + this.nyY * this.nyY + this.nyZ * this.nyZ)));
      this.nyX *= var2;
      this.nyY *= var2;
      this.nyZ *= var2;
      this.nyW *= var2;
      ...
      var2 = (float)(1.0D / Math.sqrt((double)(this.pyX * this.pyX + this.pyY * this.pyY + this.pyZ * this.pyZ)));
      this.pyX *= var2;
      this.pyY *= var2;
      this.pyZ *= var2;
      this.pyW *= var2;
      ...
      var2 = (float)(1.0D / Math.sqrt((double)(this.nzX * this.nzX + this.nzY * this.nzY + this.nzZ * this.nzZ)));
      this.nzX *= var2;
      this.nzY *= var2;
      this.nzZ *= var2;
      this.nzW *= var2;
      ...
      var2 = (float)(1.0D / Math.sqrt((double)(this.pzX * this.pzX + this.pzY * this.pzY + this.pzZ * this.pzZ)));
      this.pzX *= var2;
      this.pzY *= var2;
      this.pzZ *= var2;
      this.pzW *= var2;
