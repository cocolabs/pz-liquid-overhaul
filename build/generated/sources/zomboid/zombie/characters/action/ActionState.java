   ...
   public void parse(File var1) {
      ...
      try {
         ...
         if (this.parseTags(var6, var3, var4)) {
            this.m_tags = (String[])PZArrayUtil.concat(this.m_tags, var3.toArray(new String[0]));
            this.m_childTags = (String[])PZArrayUtil.concat(this.m_childTags, var4.toArray(new String[0]));
            if (DebugLog.isEnabled(DebugType.ActionSystem)) {
