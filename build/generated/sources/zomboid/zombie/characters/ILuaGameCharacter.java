...
public interface ILuaGameCharacter extends ILuaVariableSource, ILuaGameCharacterAttachedItems, ILuaGameCharacterDamage, ILuaGameCharacterClothing, ILuaGameCharacterHealth {
   ...
   int getPerkLevel(PerkFactory.Perks var1);

   IsoGameCharacter.PerkInfo getPerkInfo(PerkFactory.Perks var1);

   void setPerkLevelDebug(PerkFactory.Perks var1, int var2);

   void LoseLevel(PerkFactory.Perks var1);

   void LevelPerk(PerkFactory.Perks var1, boolean var2);

   void LevelPerk(PerkFactory.Perks var1);
