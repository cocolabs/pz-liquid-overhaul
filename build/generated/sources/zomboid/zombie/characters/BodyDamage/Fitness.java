...
public final class Fitness {
   ...
   public void update() {
      ...
      if (var1 != this.lastUpdate) {
         ...
         for(var9 = 0; var9 < var2.size(); ++var9) {
            this.stiffnessTimerMap.remove(var2.get(var9));
         }

         for(var9 = 0; var9 < this.bodypartToIncStiffness.size(); ++var9) {
            String var10 = (String)this.bodypartToIncStiffness.get(var9);
            Float var6 = (Float)this.stiffnessIncMap.get(var10);
            if (var6 == null) {
               return;
            }

            var6 = var6 - 1.0F;
            this.increasePain(var10);
            if (var6 <= 0.0F) {
               this.bodypartToIncStiffness.remove(var9);
               this.stiffnessIncMap.remove(var10);
               --var9;
            } else {
               this.stiffnessIncMap.put(var10, var6);
            }
         }
      }
   ...
   public void initRegularityMapProfession() {
      if (this.regularityMap.isEmpty()) {
         ...
         if (var1 || var2 || var3) {
            float var5;
            for(Iterator var4 = this.exercises.keySet().iterator(); var4.hasNext(); this.regularityMap.put(var4.next(), var5)) {
