...
public final class Thermoregulator {
   ...
   private void updateHeatDeltas() {
      ...
      Thermoregulator.ThermalNode var1 = this.core;
   ...
   private void updateNodes() {
      ...
      for(int var4 = 0; var4 < this.nodes.length; ++var4) {
         ...
         var1.skinCelcius = var1.skinCelcius + var10 * var11 * this.getSimulationMultiplier(Thermoregulator.Multiplier.SkinCelcius);
         if (var1 != this.core) {
