...
public final class BodyDamage {
   ...
   public boolean AddRandomDamageFromZombie(IsoZombie var1, String var2) {
      ...
      if (GameServer.bServer) {
         ...
         boolean var21 = false;
         var15 = false;
         var15 = this.getParentChar().addHoleFromZombieAttacks(BloodBodyPartType.FromIndex(var18));
         if (Rand.Next(100) > var5) {
            var21 = true;
            boolean var16 = false;
            if (this.getParentChar().helmetFall(var18 == BodyPartType.ToIndex(BodyPartType.Neck) || var18 == BodyPartType.ToIndex(BodyPartType.Head))) {
               return false;
            }
            ...
            Float var17;
            if (var21) {
               var17 = this.getParentChar().getBodyPartClothingDefense(var18, false);
               ...
               if (!var15) {
                  this.getParentChar().addHole(BloodBodyPartType.FromIndex(var18));
               }
               ...
               var17 = this.getParentChar().getBodyPartClothingDefense(var18, true);
               if (this.getHealth() > 0.0F) {
