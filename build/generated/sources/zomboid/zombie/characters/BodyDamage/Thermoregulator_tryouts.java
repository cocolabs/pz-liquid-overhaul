...
public class Thermoregulator_tryouts {
   ...
   private void updateTest() {
      ...
      for(int var3 = 0; var3 < this.nodes.length; ++var3) {
         ...
         var2.heatDelta = var2.heatDelta / 3.75F;
         float var5 = this.metabolicRateReal;
         var5 *= 1.0F + var2.insulation * 0.25F;
         var2.heatDelta = var2.heatDelta + var5;
         float var6 = 1.0F;
         ...
         var2.skinCelcius = var2.skinCelcius + var10 * var11;
      }
      ...
      Thermoregulator_tryouts.ThermalNode var14 = this.core;
      var14.celcius = var14.celcius + this.coreHeatDelta * var13;
   }
   ...
   private void updateTest_4() {
      ...
      for(int var3 = 0; var3 < this.nodes.length; ++var3) {
         ...
         var2.heatDelta = var2.heatDelta / (1.0F + var2.insulation);
         var2.heatDelta = var2.heatDelta / 12.0F;
         float var6 = 1.0F;
         var1 += var2.heatDelta * var2.skinSurface * var6;
         float var7 = this.core.celcius - 20.0F;
         float var8 = this.core.celcius;
         ...
         var2.skinCelcius = var2.skinCelcius + var11 * var12;
      }

      float var14 = this.metabolicRateReal / Metabolics.Default.getMet() - 1.0F;
      if (var14 > 0.0F) {
         var14 /= Metabolics.Default.getMet() * 2.0F;
      }

      this.coreHeatDelta = var1 + var14;
      var4 = 0.0025F;
      if (this.core.celcius < this.setPoint && this.coreHeatDelta < 0.0F) {
         var4 = 5.0E-5F;
      }
      ...
      Thermoregulator_tryouts.ThermalNode var15 = this.core;
      var15.celcius = var15.celcius + this.coreHeatDelta * var4;
   }
   ...
   private void updateTest_3() {
      for(int var2 = 0; var2 < this.nodes.length; ++var2) {
         ...
         var1.heatDelta = var1.heatDelta + var5;
         ...
         var1.skinCelcius = var1.skinCelcius + var9 * this.getSimulationMultiplier(Thermoregulator_tryouts.Multiplier.SkinCelcius);
      }
   ...
   private void updateTest_2() {
      ...
      for(var2 = 0; var2 < this.nodes.length; ++var2) {
         ...
         var1.heatDelta = var1.heatDelta + var6;
         float var7 = var1.heatDelta / 12.0F;
         var7 = PZMath.clamp(var7, -1.0F, 1.0F);
         float var8 = var7 - var1.primaryDelta;
         var1.primaryDelta = var1.primaryDelta + var8 * this.getSimulationMultiplier(Thermoregulator_tryouts.Multiplier.PrimaryDelta);
      ...
      for(var2 = 0; var2 < this.nodes.length; ++var2) {
         ...
         var1.skinCelcius = var1.skinCelcius + var6 * this.getSimulationMultiplier(Thermoregulator_tryouts.Multiplier.SkinCelcius);
   ...
   private void updateNodesHeatDelta() {
      ...
      for(int var8 = 0; var8 < this.nodes.length; ++var8) {
         ...
         if (var7.primaryDelta > 0.0F) {
            ...
            var7.heatDelta = var7.heatDelta - var11;
         } else {
   ...
   private void updateNodesHeatDelta_OLD() {
      ...
      for(int var10 = 0; var10 < this.nodes.length; ++var10) {
         ...
         if (var9.primaryDelta > 0.0F) {
            ...
            var9.heatDelta = var9.heatDelta - var14;
         } else {
   ...
   private void updateHeatDeltas() {
      ...
      Thermoregulator_tryouts.ThermalNode var1 = this.core;
      var1.celcius = var1.celcius + this.coreHeatDelta;
      ...
      if (this.bodyHeatDelta < 0.0F) {
         float var2 = PZMath.abs(this.bodyHeatDelta);
         if (var2 <= 1.0F) {
            this.bodyHeatDelta *= 0.8F;
         } else {
            var2 = PZMath.clamp(var2, 1.0F, 11.0F) - 1.0F;
            var2 /= 10.0F;
            this.bodyHeatDelta = -0.8F + -0.2F * var2;
         }
      }
   ...
   private void updateNodes() {
      ...
      for(int var4 = 0; var4 < this.nodes.length; ++var4) {
         ...
         var1.skinCelcius = var1.skinCelcius + var10 * var11 * this.getSimulationMultiplier(Thermoregulator_tryouts.Multiplier.SkinCelcius);
         if (var1 != this.core) {
