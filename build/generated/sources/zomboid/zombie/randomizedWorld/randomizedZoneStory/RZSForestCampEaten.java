...
public class RZSForestCampEaten extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(IsoMetaGrid.Zone var1) {
      ...
      byte var7 = 0;
      byte var8 = 0;
      this.addTileObject(var2 - 4, var3 + var8 - 2, var1.z, "camping_01_0");
      this.addTileObject(var2 - 4, var3 + var8 - 3, var1.z, "camping_01_1");
      int var16 = var7 + Rand.Next(1, 3);
      this.addTileObject(var2 - 3 + var16, var3 + var8 - 2, var1.z, "camping_01_0");
      this.addTileObject(var2 - 3 + var16, var3 + var8 - 3, var1.z, "camping_01_1");
      var16 += Rand.Next(1, 3);
      this.addTileObject(var2 - 2 + var16, var3 + var8 - 2, var1.z, "camping_01_0");
      this.addTileObject(var2 - 2 + var16, var3 + var8 - 3, var1.z, "camping_01_1");
      if (Rand.NextBool(1)) {
         var16 += Rand.Next(1, 3);
         this.addTileObject(var2 - 1 + var16, var3 + var8 - 2, var1.z, "camping_01_0");
         this.addTileObject(var2 - 1 + var16, var3 + var8 - 3, var1.z, "camping_01_1");
      }

      if (Rand.NextBool(2)) {
         var16 += Rand.Next(1, 3);
         this.addTileObject(var2 + var16, var3 + var8 - 2, var1.z, "camping_01_0");
         this.addTileObject(var2 + var16, var3 + var8 - 3, var1.z, "camping_01_1");
      }
