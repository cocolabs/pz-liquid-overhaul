...
public class RZSForestCamp extends RandomizedZoneStoryBase {
   ...
   public void randomizeZoneStory(IsoMetaGrid.Zone var1) {
      ...
      this.addTileObject(var2 + var7 - 2, var3 + var8, var1.z, "camping_01_3");
      this.addTileObject(var2 + var7 - 3, var3 + var8, var1.z, "camping_01_2");
      if (Rand.Next(100) < 70) {
         this.addTileObject(var2 + var7, var3 + var8 - 2, var1.z, "camping_01_0");
         this.addTileObject(var2 + var7, var3 + var8 - 3, var1.z, "camping_01_1");
      }

      if (Rand.Next(100) < 30) {
         this.addTileObject(var2 + var7 + 1, var3 + var8 - 2, var1.z, "camping_01_0");
         this.addTileObject(var2 + var7 + 1, var3 + var8 - 3, var1.z, "camping_01_1");
      }
