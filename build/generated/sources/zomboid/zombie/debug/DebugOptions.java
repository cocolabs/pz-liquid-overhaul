...
public final class DebugOptions implements IDebugOptionGroup {
   ...
   public final BooleanDebugOption CharacterCreateAllOutfits = this.newOption("Character.Create.AllOutfits", false);
   public final BooleanDebugOption CharacterRenderAimCone = this.newOption("Character.Debug.Render.AimCone", false);
   public final BooleanDebugOption CharacterRenderAngle = this.newOption("Character.Debug.Render.Angle", false);
   public final BooleanDebugOption CharacterRenderTestDotSide = this.newOption("Character.Debug.Render.TestDotSide", false);
   public final BooleanDebugOption CharacterRenderDeferredMovement = this.newOption("Character.Debug.Render.DeferredMovement", false);
   public final BooleanDebugOption CharacterRenderDeferredAngles = this.newOption("Character.Debug.Render.DeferredRotation", false);
   public final BooleanDebugOption CharacterRegisterDebugVariables = this.newOption("Character.Debug.DebugVariables", false);
   public final BooleanDebugOption CharacterAnimateDeferredRotationOnly = this.newOption("Character.Debug.DeferredRotationsOnly", false);
   public final BooleanDebugOption CharacterAnimateNoBoneMasks = this.newOption("Character.Debug.NoBoneMasks", false);
   public final BooleanDebugOption CharacterAnimateNoBoneTwists = this.newOption("Character.Debug.NoBoneTwists", false);
   public final BooleanDebugOption CharacterAnimateZeroCounterRotationBone = this.newOption("Character.Debug.ZeroCounterRotation", false);
   public final BooleanDebugOption ModelRenderTranslationData = this.newOption("Character.Debug.Render.Translation_Data", false);
   public final BooleanDebugOption ModelRenderBip01 = this.newOption("Character.Debug.Render.Bip01", false);
   public final BooleanDebugOption ModelRenderPrimaryHandBone = this.newOption("Character.Debug.HandBones.Primary", false);
   public final BooleanDebugOption ModelRenderSecondaryHandBone = this.newOption("Character.Debug.HandBones.Secondary", false);
   public final BooleanDebugOption ModelRenderSkipCharacters = this.newOption("Character.Debug.SkipCharacters", false);
   ...
   public final BooleanDebugOption CollideWithObstaclesRadius = this.newOption("CollideWithObstacles.Radius", false);
   public final BooleanDebugOption CollideWithObstaclesRender = this.newOption("CollideWithObstacles.Render", false);
   ...
   public final BooleanDebugOption UIDebugConsole = this.newOption("UI.DebugConsole.Enabled", true);
