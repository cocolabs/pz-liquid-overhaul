...
public final class GlobalObjectLookup {
   ...
   public GlobalObjectLookup(SGlobalObjectSystem var1) {
      this.system = var1;
   }
   ...
   private GlobalObjectLookup.Cell getCellAt(int var1, int var2, boolean var3) {
      ...
      if (var4 >= 0 && var5 >= 0 && var4 < metaGrid.getWidth() * 300 && var5 < metaGrid.getHeight() * 300) {
         ...
         if (cells[var8] == null && var3) {
            cells[var8] = new GlobalObjectLookup.Cell(metaGrid.minX + var6, metaGrid.minY + var7);
         }
   ...
   public static void init(IsoMetaGrid var0) {
      metaGrid = var0;
      cells = new GlobalObjectLookup.Cell[var0.getWidth() * var0.getHeight()];
   }

   public static void Reset() {
      for(int var0 = 0; var0 < cells.length; ++var0) {
         GlobalObjectLookup.Cell var1 = cells[var0];
         if (var1 != null) {
            var1.Reset();
         }
      }
