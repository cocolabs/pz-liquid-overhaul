...
public enum BloodClothingType {
   ...
   private static void init() {
      if (coveredParts == null) {
         ...
         var9.add(BloodBodyPartType.Neck);
   ...
   public static void addHole(BloodBodyPartType var0, HumanVisual var1, ArrayList var2) {
      ...
      for(int var4 = var2.size() - 1; var4 >= 0; --var4) {
         ...
         if (var6 != null && (var5.getInventoryItem() == null || !var5.getInventoryItem().isBroken())) {
            ArrayList var7 = var6.getBloodClothingType();
            if (var7 != null) {
               for(int var8 = 0; var8 < var7.size(); ++var8) {
                  BloodClothingType var9 = (BloodClothingType)var6.getBloodClothingType().get(var8);
                  if (((ArrayList)coveredParts.get(var9)).contains(var0) && var6.canHaveHoles && var5.getHole(var0) == 0.0F) {
                     var3 = var5;
                     break;
                  }
               }
      ...
      if (var3 != null) {
         var3.setHole(var0);
         Clothing var10 = (Clothing)Type.tryCastTo(var3.getInventoryItem(), Clothing.class);
         if (var10 != null) {
            var10.removePatch(var0);
            var10.setCondition(var10.getCondition() - var10.getCondLossPerHole());
         }
      } else {
         var1.setHole(var0);
      }
