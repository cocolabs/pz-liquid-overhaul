   ...
   public static void fillContainer(ItemContainer var0, IsoPlayer var1) {
      if (!GameClient.bClient && !"Tutorial".equals(Core.GameMode)) {
         if (var0 != null) {
            ...
            if (var2 != null) {
               var3 = var2.getRoom();
               ItemPickerJava.ItemPickerContainer var5;
               if (!var0.getType().equals("inventorymale") && !var0.getType().equals("inventoryfemale")) {
                  ItemPickerJava.ItemPickerRoom var9 = null;
                  if (rooms.containsKey("all")) {
                     var9 = (ItemPickerJava.ItemPickerRoom)rooms.get("all");
                  }

                  String var10;
                  if (var3 != null && rooms.containsKey(var3.getName())) {
                     var10 = var3.getName();
                     ItemPickerJava.ItemPickerRoom var6 = (ItemPickerJava.ItemPickerRoom)rooms.get(var10);
                     ...
                     if (var7 == null) {
                        fillContainerType(var9, var0, var10, var1);
                        LuaEventManager.triggerEvent("OnFillContainer", var10, var0.getType(), var0);
                     } else {
                        if (rooms.containsKey(var3.getName())) {
                           var9 = (ItemPickerJava.ItemPickerRoom)rooms.get(var3.getName());
                        }
                  ...
                  for(int var4 = 0; var4 < var0.getItems().size(); ++var4) {
                     if (var0.getItems().get(var4) instanceof InventoryContainer) {
                        var5 = (ItemPickerJava.ItemPickerContainer)containers.get(((InventoryItem)var0.getItems().get(var4)).getType());
                        if (var5 != null && Rand.Next(var5.fillRand) == 0) {
                           rollContainerItem((InventoryContainer)var0.getItems().get(var4), (IsoGameCharacter)null, (ItemPickerJava.ItemPickerContainer)containers.get(((InventoryItem)var0.getItems().get(var4)).getType()));
                        }
                     }
                  }

                  ItemPickerJava.ItemPickerContainer var8 = (ItemPickerJava.ItemPickerContainer)((ItemPickerJava.ItemPickerRoom)rooms.get("all")).Containers.get(var0.getType());
                  rollItem(var8, var0, true, var1, (ItemPickerJava.ItemPickerRoom)null);
               }
            }
         }
      }
   ...
   private static void rollProceduralItem(ArrayList var0, ItemContainer var1, float var2, IsoGameCharacter var3, ItemPickerJava.ItemPickerRoom var4) {
      if (var1.getSourceGrid() != null && var1.getSourceGrid().getRoom() != null) {
         ...
         for(int var8 = 0; var8 < var0.size(); ++var8) {
            ...
            int var11 = var9.min;
            int var12 = var9.max;
            List var13 = var9.forceForItems;
            List var14 = var9.forceForZones;
            ...
            int var16;
            if (var13 != null) {
               for(int var22 = var1.getSourceGrid().getRoom().getRoomDef().x; var22 < var1.getSourceGrid().getRoom().getRoomDef().x2; ++var22) {
                  for(var16 = var1.getSourceGrid().getRoom().getRoomDef().y; var16 < var1.getSourceGrid().getRoom().getRoomDef().y2; ++var16) {
                     IsoGridSquare var17 = var1.getSourceGrid().getCell().getGridSquare(var22, var16, var1.getSourceGrid().z);
                     if (var17 != null) {
                        for(int var18 = 0; var18 < var17.getObjects().size(); ++var18) {
                           IsoObject var19 = (IsoObject)var17.getObjects().get(var18);
                           if (var13.contains(var19.getSprite().name)) {
                              var6.clear();
                              var6.add(var10);
                              break;
                           }
               ...
               ArrayList var15 = IsoWorld.instance.MetaGrid.getZonesAt(var1.getSourceGrid().x, var1.getSourceGrid().y, 0);

               for(var16 = 0; var16 < var15.size(); ++var16) {
                  if ((Integer)var5.get(var10) < var12 && (var14.contains(((IsoMetaGrid.Zone)var15.get(var16)).type) || var14.contains(((IsoMetaGrid.Zone)var15.get(var16)).name))) {
                     var6.clear();
                     var6.add(var10);
                     break;
                  }
         ...
         String var20 = null;
         if (!var6.isEmpty()) {
            var20 = (String)PZArrayUtil.pickRandom((List)var6);
         } else if (!var7.isEmpty()) {
            var20 = (String)PZArrayUtil.pickRandom((List)var7);
         }

         if (var20 != null) {
            ItemPickerJava.ItemPickerContainer var21 = (ItemPickerJava.ItemPickerContainer)ProceduralDistributions.get(var20);
            if (var21 != null) {
               if (var21.junk != null) {
                  doRollItem(var21.junk, var1, var2, var3, true, true, var4);
               }

               doRollItem(var21, var1, var2, var3, true, false, var4);
               var5.put(var20, (Integer)var5.get(var20) + 1);
            }
         }
      }
   }
         ...
         for(int var12 = 0; var12 < var11.length; ++var12) {
            ...
            if ((float)Rand.Next(10000) <= var14 * 100.0F * var15 + var2 * 10.0F) {
               ...
               if (var16 instanceof Key) {
                  Key var17 = (Key)var16;
                  var17.takeKeyId();
                  var17.setName(Translator.getText("IGUI_HouseKey") + " " + var17.getKeyId());
            ...
            for(int var11 = 0; var11 < var10.length; ++var11) {
               ...
               if ((float)Rand.Next(10000) <= var13 * 100.0F * var14 + var4 * 10.0F) {
                  ...
                  if (var15 instanceof Key) {
                     Key var19 = (Key)var15;
                     var19.takeKeyId();
                     var19.setName(Translator.getText("IGUI_HouseKey") + " " + var19.getKeyId());
