...
public final class HandWeapon extends InventoryItem {
   ...
   public void DoTooltip(ObjectTooltip var1, ObjectTooltip.Layout var2) {
      ...
      if (Core.getInstance().isNewReloading()) {
         ...
         if (var19 != null) {
            ...
            if (var23 == null) {
               var23 = ScriptManager.instance.FindItem(this.getModule() + "." + var19);
            }
   ...
   public void save(ByteBuffer var1, boolean var2) throws IOException {
      ...
      if (this.getScope() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getScope().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      if (this.getClip() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getClip().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      if (this.getRecoilpad() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getRecoilpad().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      if (this.getSling() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getSling().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      if (this.getStock() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getStock().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      if (this.getCanon() != null) {
         var1.put((byte)1);
         GameWindow.WriteString(var1, this.getCanon().getFullType());
      } else {
         var1.put((byte)0);
      }
      ...
      var1.put((byte)(this.containsClip ? 1 : 0));
      var1.put((byte)(this.roundChambered ? 1 : 0));
      var1.put((byte)(this.isJammed ? 1 : 0));
   }
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      this.setContainsClip(var1.get() == 1);
      if (StringUtils.isNullOrWhitespace(this.magazineType)) {
         this.setContainsClip(false);
      }

      this.setRoundChambered(var1.get() == 1);
      this.setJammed(var1.get() == 1);
   }
   ...
   public void setInsertAmmoSound(String var1) {
      this.insertAmmoSound = var1;
   }
   ...
   public void setEjectAmmoSound(String var1) {
      this.ejectAmmoSound = var1;
   }
