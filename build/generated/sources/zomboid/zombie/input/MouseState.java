...
public final class MouseState {
   ...
   public void poll() {
      ...
      this.m_isCreated = this.m_isCreated || org.lwjgl.input.Mouse.isCreated();
      if (this.m_isCreated) {
         if (var1) {
            this.m_buttonDownStates = new boolean[org.lwjgl.input.Mouse.getButtonCount()];
         }

         this.m_mouseX = org.lwjgl.input.Mouse.getX();
         this.m_mouseY = org.lwjgl.input.Mouse.getY();
         this.m_wheelDelta = org.lwjgl.input.Mouse.getDWheel();
         this.m_wasPolled = true;

         for(int var2 = 0; var2 < this.m_buttonDownStates.length; ++var2) {
            this.m_buttonDownStates[var2] = org.lwjgl.input.Mouse.isButtonDown(var2);
         }
   ...
   public void setCursorPosition(int var1, int var2) {
      org.lwjgl.input.Mouse.setCursorPosition(var1, var2);
   }
}
