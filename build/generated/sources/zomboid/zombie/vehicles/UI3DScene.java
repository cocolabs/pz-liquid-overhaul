...
public final class UI3DScene extends UIElement {
   ...
   private static final ObjectPool s_SetModelCameraPool = new ObjectPool(() -> {
      return new UI3DScene.SetModelCamera();
   });
   ...
   private static final ObjectPool s_posRotPool = new ObjectPool(() -> {
      return new UI3DScene.PositionRotation();
   });
   private final ArrayList m_aabb;
   private static final ObjectPool s_aabbPool = new ObjectPool(() -> {
      return new UI3DScene.AABB();
   });
   private final ArrayList m_box3D;
   private static final ObjectPool s_box3DPool = new ObjectPool(() -> {
      return new UI3DScene.Box3D();
   });
   ...
   public Object fromLua1(String var1, Object var2) {
      ...
      case 4:
         ...
         for(int var17 = 0; var17 < this.m_objects.size(); ++var17) {
            UI3DScene.SceneModel var27 = (UI3DScene.SceneModel)Type.tryCastTo(this.m_objects.get(var17), UI3DScene.SceneModel.class);
   ...
   private static final class StateData {
      ...
      private StateData() {
         this.m_projection = new Matrix4f();
         this.m_modelView = new Matrix4f();
         this.m_objectData = new ArrayList();
         this.m_gizmo = null;
   ...
   private static final class TranslateGizmoRenderData {
      ...
      // $FF: synthetic method
      TranslateGizmoRenderData(Object var1) {
         this();
      }
   }
   ...
   private final class VehicleSceneModelCamera extends UI3DScene.SceneModelCamera {
      ...
      // $FF: synthetic method
      VehicleSceneModelCamera(Object var2) {
         this();
      }
   }
   ...
   private final class CharacterSceneModelCamera extends UI3DScene.SceneModelCamera {
      ...
      // $FF: synthetic method
      CharacterSceneModelCamera(Object var2) {
         this();
      }
   }
   ...
   private static class VehicleRenderData extends UI3DScene.SceneObjectRenderData {
      ...
      UI3DScene.SceneObjectRenderData initVehicle(UI3DScene.SceneVehicle var1) {
         ...
         if (var3.getModel() == null) {
            ...
            Matrix4f var7 = UI3DScene.allocMatrix4f();
            var7.translationRotateScale(var5.x * 1.0F, var5.y, var5.z, 0.0F, 0.0F, 0.0F, 1.0F, var4);
            this.m_transform.mul((Matrix4fc)var7, var7);

            for(int var8 = 0; var8 < var3.getPartCount(); ++var8) {
               VehicleScript.Part var9 = var3.getPart(var8);
               if (var9.wheel != null) {
                  this.initWheelModel(var1, var9, var7);
               }
            }
      ...
      private void initVehicleModel(UI3DScene.SceneVehicle var1) {
         ...
         Vector3f var10 = var2.getModel().getRotate();
         var7.rotationXYZ(var10.x * 0.017453292F, var10.y * 0.017453292F, var10.z * 0.017453292F);
         Vector3f var11 = var2.getModel().getOffset();
         var9.translationRotateScale(var11.x * 1.0F, var11.y, var11.z, var7.x, var7.y, var7.z, var7.w, var3 * var4 * var6, var3 * var4, var3 * var4);
         if (var1.m_model.Mesh != null && var1.m_model.Mesh.isReady() && var1.m_model.Mesh.m_transform != null) {
            ...
            var9.mul(var1.m_model.Mesh.m_transform);
            var1.m_model.Mesh.m_transform.transpose();
         }

         this.m_transform.mul((Matrix4fc)var9, var9);
         UI3DScene.releaseQuaternionf(var7);
         this.m_models.add(var1.m_model);
         this.m_transforms.add(var9);
      }
      ...
      private void initWheelModel(UI3DScene.SceneVehicle var1, VehicleScript.Part var2, Matrix4f var3) {
         ...
         if (var6 != null && !var2.models.isEmpty()) {
            ...
            if (var10 != null) {
               ...
               var18.translationRotateScale(var8.x * 1.0F, var8.y, var8.z, var15.x, var15.y, var15.z, var15.w, var11 * var12 * var13, var11 * var12, var11 * var12);
               var17.mul(var18);
               UI3DScene.releaseMatrix4f(var18);
               var3.mul((Matrix4fc)var17, var17);
               if (var10.Mesh != null && var10.Mesh.isReady() && var10.Mesh.m_transform != null) {
                  var10.Mesh.m_transform.transpose();
                  var17.mul(var10.Mesh.m_transform);
                  var10.Mesh.m_transform.transpose();
               }

               UI3DScene.releaseQuaternionf(var15);
               this.m_models.add(var10);
               this.m_transforms.add(var17);
            }
         }
      }
   ...
   private static class SceneObjectRenderData {
      ...
      // $FF: synthetic method
      SceneObjectRenderData(Object var1) {
         this();
      }
   }
