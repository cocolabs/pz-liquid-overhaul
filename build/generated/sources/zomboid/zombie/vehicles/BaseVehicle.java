...
public final class BaseVehicle extends IsoMovingObject implements Thumpable {
   ...
   public static final ArrayList RPMList = new ArrayList();
   ...
   public void createPhysics() {
      ...
      if (this.script != null) {
         ...
         VehiclePart var2;
         int var3;
         for(var3 = 0; var3 < this.parts.size(); ++var3) {
         ...
         if (var3 != null && !StringUtils.isNullOrWhitespace(var3.anim)) {
            ...
            if (var4 != null) {
               ...
               if (var5 != null && var5.isReady()) {
                  if (var5.getMultiTrack().getTrackCount() > 0) {
                     var5.reset();
                  }

                  if (var5.getSkinningData() == null || var5.getSkinningData().AnimationClips.containsKey(var3.anim)) {
                     AnimationTrack var6 = var5.play(var3.anim, var3.bLoop);
                     if (var6 != null) {
                        var6.setLayerIdx(0);
                        var6.BlendDelta = 1.0F;
                        var6.SpeedDelta = var3.rate;
                        var6.IsPlaying = var3.bAnimate;
                        var6.reverse = var3.bReverse;
                     }
   ...
   public void save(ByteBuffer var1) throws IOException {
      if (this.square != null) {
         float var2 = 5.0E-4F;
         this.x = PZMath.clamp(this.x, (float)this.square.x + var2, (float)(this.square.x + 1) - var2);
         this.y = PZMath.clamp(this.y, (float)this.square.y + var2, (float)(this.square.y + 1) - var2);
      }

      super.save(var1);
      Quaternionf var6 = this.savedRot;
      Transform var3 = this.getWorldTransform(this.tempTransform);
      var1.putFloat(var3.origin.y);
      var3.getRotation(var6);
      var1.putFloat(var6.x);
      var1.putFloat(var6.y);
      var1.putFloat(var6.z);
      var1.putFloat(var6.w);
      ...
      for(int var4 = 0; var4 < this.parts.size(); ++var4) {
         VehiclePart var5 = (VehiclePart)this.parts.get(var4);
         var5.save(var1);
      }
      ...
      Iterator var7 = this.bloodIntensity.entrySet().iterator();

      while(var7.hasNext()) {
         Entry var8 = (Entry)var7.next();
         GameWindow.WriteStringUTF(var1, (String)var8.getKey());
         var1.put((Byte)var8.getValue());
      }
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      String var13;
      if (var2 >= 122) {
         var13 = GameWindow.ReadString(var1);
      ...
      if (var2 >= 133 && var1.get() == 1) {
         ...
         var14.load(var1, var2, false);
         this.setCurrentKey(var14);
      }
      ...
      if (var2 >= 165) {
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            byte var12 = var1.get();
            this.bloodIntensity.put(var11, var12);
         }
      }
   ...
   public void update() {
      if (this.removedFromWorld) {
         ...
         boolean var17 = this.getVehicleTowedBy() != null && this.getVehicleTowedBy().getController().isEnable;
         boolean var2 = this.getVehicleTowing() != null && this.getVehicleTowing().getDriver() != null;
         if (this.physics != null) {
   ...
   protected void updateAnimationPlayer(AnimationPlayer var1, VehiclePart var2) {
      if (var1 != null && var1.isReady()) {
         ...
         if (var2 != null) {
            if (var3.getTrackCount() <= 0) {
               VehicleDoor var7 = var2.getDoor();
               if (var7 != null) {
                  this.playPartAnim(var2, var7.isOpen() ? "Opened" : "Closed");
               }
   ...
   private void initShadowPoly() {
      ...
      float var4 = 1.0F;
      float var5 = 0.0F;
      float var6 = var2.x * var4 + var5 * 2.0F;
      float var7 = var2.z * var4 + var5 * 2.0F;
      float var8 = var2.y * var4 + var5 * 2.0F;
      var6 /= 2.0F;
      var7 /= 2.0F;
      var8 /= 2.0F;
      Vector4f var9 = this.script.getShadowOffset();
      Vector3f var10 = (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc();
      if (var1.x < 0.0F) {
         this.getWorldPos(var3.x - var9.x - var6, 0.0F, var3.z + var9.z + var7, var10);
         this.shadowCoord.x1 = var10.x;
         this.shadowCoord.y1 = var10.y;
         this.getWorldPos(var3.x + var9.y + var6, 0.0F, var3.z + var9.z + var7, var10);
         this.shadowCoord.x2 = var10.x;
         this.shadowCoord.y2 = var10.y;
         this.getWorldPos(var3.x + var9.y + var6, 0.0F, var3.z - var9.w - var7, var10);
         this.shadowCoord.x3 = var10.x;
         this.shadowCoord.y3 = var10.y;
         this.getWorldPos(var3.x + -var9.x - var6, 0.0F, var3.z - var9.w - var7, var10);
         this.shadowCoord.x4 = var10.x;
         this.shadowCoord.y4 = var10.y;
      } else {
         this.getWorldPos(var3.x - var9.x - var6, 0.0F, var3.z + var9.z + var7, var10);
         this.shadowCoord.x1 = var10.x;
         this.shadowCoord.y1 = var10.y;
   ...
   protected void updateTransform() {
      if (this.sprite.modelSlot != null) {
         ...
         var4.y *= -1.0F;
         var4.z *= -1.0F;
         Matrix4f var8 = var4.get(var6);
         float var9 = 1.0F;
         if (this.sprite.modelSlot.model.m_modelScript != null) {
            var9 = this.sprite.modelSlot.model.m_modelScript.invertX ? -1.0F : 1.0F;
         }

         Vector3f var10 = this.script.getModel().getOffset();
         Vector3f var11 = this.getScript().getModel().getRotate();
         var5.rotationXYZ(var11.x * 0.017453292F, var11.y * 0.017453292F, var11.z * 0.017453292F);
         this.renderTransform.translationRotateScale(var10.x * -1.0F, var10.y, var10.z, var5.x, var5.y, var5.z, var5.w, var1 * var2 * var9, var1 * var2, var1 * var2);
         var8.mul((Matrix4fc)this.renderTransform, this.renderTransform);
         this.vehicleTransform.translationRotateScale(var10.x * -1.0F, var10.y, var10.z, 0.0F, 0.0F, 0.0F, 1.0F, var1);
         var8.mul((Matrix4fc)this.vehicleTransform, this.vehicleTransform);

         for(int var22 = 0; var22 < this.models.size(); ++var22) {
            BaseVehicle.ModelInfo var23 = (BaseVehicle.ModelInfo)this.models.get(var22);
            VehicleScript.Model var24 = var23.scriptModel;
            var11 = var24.getOffset();
            Vector3f var12 = var24.getRotate();
            float var13 = var24.scale;
            var2 = 1.0F;
            float var14 = 1.0F;
            if (var23.modelScript != null) {
               var2 = var23.modelScript.scale;
               var14 = var23.modelScript.invertX ? -1.0F : 1.0F;
            }

            var5.rotationXYZ(var12.x * 0.017453292F, var12.y * 0.017453292F, var12.z * 0.017453292F);
            if (var23.wheelIndex == -1) {
               var23.renderTransform.translationRotateScale(var11.x * -1.0F, var11.y, var11.z, var5.x, var5.y, var5.z, var5.w, var13 * var2 * var14, var13 * var2, var13 * var2);
               this.vehicleTransform.mul((Matrix4fc)var23.renderTransform, var23.renderTransform);
            } else {
               BaseVehicle.WheelInfo var15 = this.wheelInfo[var23.wheelIndex];
               float var16 = var15.steering;
               float var17 = var15.rotation;
               VehicleScript.Wheel var18 = this.getScript().getWheel(var23.wheelIndex);
               BaseVehicle.VehicleImpulse var19 = var23.wheelIndex < this.impulseFromSquishedZombie.length ? this.impulseFromSquishedZombie[var23.wheelIndex] : null;
               float var20 = var19 != null && var19.enable ? 0.05F : 0.0F;
               if (var15.suspensionLength == 0.0F) {
                  var6.translation(var18.offset.x / var1 * -1.0F, var18.offset.y / var1, var18.offset.z / var1);
               } else {
                  var6.translation(var18.offset.x / var1 * -1.0F, (var18.offset.y + this.script.getSuspensionRestLength() - var15.suspensionLength) / var1 + var20 * 0.5F, var18.offset.z / var1);
               }

               var23.renderTransform.identity();
               var23.renderTransform.mul(var6);
               var23.renderTransform.rotateY(var16 * -1.0F);
               var23.renderTransform.rotateX(var17);
               var6.translationRotateScale(var11.x * -1.0F, var11.y, var11.z, var5.x, var5.y, var5.z, var5.w, var13 * var2 * var14, var13 * var2, var13 * var2);
               var23.renderTransform.mul(var6);
               this.vehicleTransform.mul((Matrix4fc)var23.renderTransform, var23.renderTransform);
            }
         }
         ...
         if (!(Math.abs(var1.x - this.x) < 0.01F) && !(Math.abs(var1.y - this.y) < 0.01F)) {
            ...
            if (var4 < 0.05F) {
               ...
               if (var6 < 0.0F && !GameServer.bServer) {
                  this.ApplyImpulse(var1, this.getFudgedMass() * 7.0F * var4 / var2 * Math.abs(var6));
               }
               ...
               if (GameClient.bClient) {
                  ...
                  Vector2 var7 = (Vector2)((BaseVehicle.Vector2ObjectPool)TL_vector2_pool.get()).alloc();
                  var1.Hit(this, var4 + this.physics.clientForce / this.getFudgedMass(), var6, var7.set(-var5.x, -var5.z));
                  ((BaseVehicle.Vector2ObjectPool)TL_vector2_pool.get()).release(var7);
                  ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var5);
                  long var8 = System.currentTimeMillis();
                  long var10 = (var8 - this.zombieHitTimestamp) / 1000L;
                  this.zombiesHits = Math.max(this.zombiesHits - (int)var10, 0);
                  if (var8 - this.zombieHitTimestamp > 700L) {
                     this.zombieHitTimestamp = var8;
                     ++this.zombiesHits;
                     this.zombiesHits = Math.min(this.zombiesHits, 20);
                  }

                  if (var4 >= 5.0F || this.zombiesHits > 10) {
                     var4 = this.getCurrentSpeedKmHour() / 5.0F;
                     Vector3f var12 = (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc();
                     this.getLocalPos(var1.x, var1.y, var1.z, var12);
                     int var13;
                     if (var12.z > 0.0F) {
                        var13 = this.caclulateDamageWithBodies(true);
                        this.addDamageFrontHitAChr(var13);
                     } else {
                        var13 = this.caclulateDamageWithBodies(false);
                        this.addDamageRearHitAChr(var13);
                     }
                  }
   ...
   public void updateLights() {
      ...
      if (this.headlightsOn && this.getBatteryCharge() > 0.0F) {
         VehiclePart var6 = this.getPartById("HeadlightLeft");
         if (var6 != null && var6.getInventoryItem() != null) {
            var2 = true;
         }

         var6 = this.getPartById("HeadlightRight");
         if (var6 != null && var6.getInventoryItem() != null) {
            var3 = true;
         }

         var6 = this.getPartById("HeadlightRearLeft");
         if (var6 != null && var6.getInventoryItem() != null) {
            var5 = true;
         }

         var6 = this.getPartById("HeadlightRearRight");
         if (var6 != null && var6.getInventoryItem() != null) {
            var4 = true;
         }
      }

      var1.textureLightsEnables2[4] = var3 ? 1.0F : 0.0F;
      var1.textureLightsEnables2[8] = var2 ? 1.0F : 0.0F;
      var1.textureLightsEnables2[12] = var4 ? 1.0F : 0.0F;
      var1.textureLightsEnables2[1] = var5 ? 1.0F : 0.0F;
      boolean var10 = this.stoplightsOn && this.getBatteryCharge() > 0.0F;
      ...
      if (DebugOptions.instance.VehicleCycleColor.getValue()) {
         float var7 = (float)(System.currentTimeMillis() % 2000L);
         float var8 = (float)(System.currentTimeMillis() % 7000L);
         float var9 = (float)(System.currentTimeMillis() % 11000L);
         var1.painColor.x = var7 / 2000.0F;
         var1.painColor.y = var8 / 7000.0F;
         var1.painColor.z = var9 / 11000.0F;
      }
   ...
   private void doBloodOverlay() {
      if (this.sprite.modelSlot != null) {
         ...
         if (Core.getInstance().getOptionBloodDecals() != 0) {
            ...
            if (s_PartToMaskMap.isEmpty()) {
               s_PartToMaskMap.put("WindowFront", 10);
               s_PartToMaskMap.put("WindowRear", 14);
               s_PartToMaskMap.put("WindowFrontLeft", 2);
               s_PartToMaskMap.put("WindowFrontRight", 9);
               s_PartToMaskMap.put("WindowRearLeft", 6);
               s_PartToMaskMap.put("WindowRearRight", 13);
            }
      ...
      if (this.script != null) {
         ...
         if (var9 || this.square.lighting[var8].bSeen()) {
            if (!var9 && !this.square.lighting[var8].bCouldSee()) {
               this.targetAlpha[var8] = 0.0F;
            } else {
               this.targetAlpha[var8] = 1.0F;
            }
            ...
            float var11 = 1.5F;
            float[] var10000;
            if (this.alpha[var8] < this.targetAlpha[var8]) {
               var10000 = this.alpha;
               var10000[var8] += alphaStep * var12;
               if (this.alpha[var8] > this.targetAlpha[var8]) {
                  this.alpha[var8] = this.targetAlpha[var8];
               }
            } else if (this.alpha[var8] > this.targetAlpha[var8]) {
               var10000 = this.alpha;
               var10000[var8] -= alphaStep / var11;
               if (this.alpha[var8] < this.targetAlpha[var8]) {
                  this.alpha[var8] = this.targetAlpha[var8];
               }
            }

            if (this.alpha[var8] < 0.0F) {
               this.alpha[var8] = 0.0F;
            }

            if (this.alpha[var8] > 1.0F) {
               this.alpha[var8] = 1.0F;
            }
         ...
         if (this.script != null) {
            ...
            if (this.square.lighting[var1].bSeen()) {
               ...
               if (vehicleShadow == null) {
                  byte var2 = 0;
                  int var4 = var2 | (TextureID.bUseCompression ? 4 : 0);
                  vehicleShadow = Texture.getSharedTexture("media/vehicleShadow.png", var4);
               }

               if (vehicleShadow != null && this.getCurrentSquare() != null) {
                  float var5 = 0.6F * this.alpha[var1];
                  ColorInfo var3 = this.getCurrentSquare().lighting[var1].lightInfo();
                  var5 *= (var3.r + var3.g + var3.b) / 3.0F;
                  if (this.polyDirty) {
                     this.getPoly();
                  }

                  SpriteRenderer.instance.renderPoly(vehicleShadow, (float)((int)IsoUtils.XToScreenExact(this.shadowCoord.x1, this.shadowCoord.y1, 0.0F, 0)), (float)((int)IsoUtils.YToScreenExact(this.shadowCoord.x1, this.shadowCoord.y1, 0.0F, 0)), (float)((int)IsoUtils.XToScreenExact(this.shadowCoord.x2, this.shadowCoord.y2, 0.0F, 0)), (float)((int)IsoUtils.YToScreenExact(this.shadowCoord.x2, this.shadowCoord.y2, 0.0F, 0)), (float)((int)IsoUtils.XToScreenExact(this.shadowCoord.x3, this.shadowCoord.y3, 0.0F, 0)), (float)((int)IsoUtils.YToScreenExact(this.shadowCoord.x3, this.shadowCoord.y3, 0.0F, 0)), (float)((int)IsoUtils.XToScreenExact(this.shadowCoord.x4, this.shadowCoord.y4, 0.0F, 0)), (float)((int)IsoUtils.YToScreenExact(this.shadowCoord.x4, this.shadowCoord.y4, 0.0F, 0)), 1.0F, 1.0F, 1.0F, 0.8F * var5);
               }
   ...
   public void getWheelForwardVector(int var1, Vector3f var2) {
      ...
      var4.mulGeneric(var5.setTranslation(0.0F, 0.0F, 0.0F), var4);
      ((BaseVehicle.Matrix4fObjectPool)TL_matrix4f_pool.get()).release(var5);
   ...
   private void randomizeContainer(VehiclePart var1) {
      if (!GameClient.bClient) {
         ItemPickerJava.VehicleDistribution var2 = null;
         boolean var3 = true;
         ItemPickerJava.ItemPickerRoom var4 = null;
         if (ItemPickerJava.VehicleDistributions.containsKey(this.getScriptName().replaceFirst("Base.", "") + this.getSkinIndex())) {
            var3 = false;
            var2 = (ItemPickerJava.VehicleDistribution)ItemPickerJava.VehicleDistributions.get(this.getScriptName().replaceFirst("Base.", "") + this.getSkinIndex());
         } else {
            var2 = (ItemPickerJava.VehicleDistribution)ItemPickerJava.VehicleDistributions.get(this.getScriptName().replaceFirst("Base.", ""));
         }

         if (var2 != null) {
            if (var3 && Rand.Next(100) <= 8 && !var2.Specific.isEmpty()) {
               var4 = (ItemPickerJava.ItemPickerRoom)PZArrayUtil.pickRandom((List)var2.Specific);
            } else {
               var4 = var2.Normal;
            }

            if (!StringUtils.isNullOrEmpty(this.specificDistributionId)) {
               for(int var5 = 0; var5 < var2.Specific.size(); ++var5) {
                  ItemPickerJava.ItemPickerRoom var6 = (ItemPickerJava.ItemPickerRoom)var2.Specific.get(var5);
            ...
            if (var4 != null) {
               if (!var1.getId().contains("Seat") && !var4.Containers.containsKey(var1.getId())) {
                  DebugLog.log("NO CONT DISTRIB FOR PART: " + var1.getId() + " CAR: " + this.getScriptName().replaceFirst("Base.", ""));
               }

               ItemPickerJava.fillContainerType(var4, var1.getItemContainer(), "", (IsoGameCharacter)null);
      ...
      if (!this.getScriptName().contains("Trailer") && !var1.getScriptName().contains("Trailer")) {
         ...
         if (var3 != null && var3.isUpdateConstraint()) {
            ...
            if (var9 != this.towConstraintZOffset) {
               this.addPointConstraint(var1, this.towAttachmentSelf, var1.towAttachmentSelf, var9);
            }
   ...
   public void addPointConstraint(BaseVehicle var1, String var2, String var3) {
      this.addPointConstraint(var1, var2, var3, (Float)null);
   }

   public void addPointConstraint(BaseVehicle var1, String var2, String var3, Float var4) {
      this.breakConstraint(true);
      var1.breakConstraint(true);
      BaseVehicle.Vector3fObjectPool var6 = (BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get();
      Vector3f var7 = this.getTowingLocalPos(var2, (Vector3f)var6.alloc());
      Vector3f var8 = var1.getTowedByLocalPos(var3, (Vector3f)var6.alloc());
      if (var7 != null && var8 != null) {
         ModelAttachment var9 = this.script.getAttachmentById(var2);
         float var10 = 0.0F;
         float var11 = 0.0F;
         if (var9 != null && var9.getZOffset() != 0.0F) {
            var10 = var9.getZOffset();
         }
         ...
         this.constraintTowing = Bullet.addPointConstraint(this.VehicleID, var1.VehicleID, var7.x, var7.y, var7.z + var10, var8.x, var8.y, var8.z + var11);
         var1.constraintTowing = this.constraintTowing;
         this.setVehicleTowing(var1, var2, var3, var10);
         var1.setVehicleTowedBy(this, var2, var3, var11);
         var6.release(var7);
         var6.release(var8);
         this.constraintChanged();
         var1.constraintChanged();
   ...
   public void breakConstraint(boolean var1) {
         ...
         if (var1 != null && var1.physics != null && var1.constraintTowing == -1) {
            ...
            if (Math.abs(var5) > 0.2F) {
               ...
               if (Math.abs(var6) > 0.2F) {
                  ...
                  if (this.createPhysicsTime + 1000L > var7) {
                     return false;
                  } else if (var1.createPhysicsTime + 1000L > var7) {
                     return false;
                  } else {
                     BaseVehicle.Vector3fObjectPool var9 = (BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get();
                     Vector3f var10 = this.getTowingWorldPos(var2, (Vector3f)var9.alloc());
                     Vector3f var11 = var1.getTowedByWorldPos(var3, (Vector3f)var9.alloc());
                     if (var10 != null && var11 != null) {
                        float var12 = IsoUtils.DistanceToSquared(var10.x, var10.y, var10.z, var11.x, var11.y, var11.z);
                        var9.release(var10);
                        var9.release(var11);
                        ModelAttachment var13 = this.script.getAttachmentById(var2);
                        ModelAttachment var14 = var1.script.getAttachmentById(var3);
                        if (var13 != null && var13.getCanAttach() != null && !var13.getCanAttach().contains(var3)) {
                           return false;
                        } else if (var14 != null && var14.getCanAttach() != null && !var14.getCanAttach().contains(var2)) {
                           return false;
                        } else {
                           return var12 < 2.0F;
                        }
            ...
            if (this.vehicleTowingID != -1) {
               ...
               if (var1 != null) {
                  if (this.canAttachTrailer(var1, this.towAttachmentSelf, this.towAttachmentOther)) {
                     this.addPointConstraint(var1, this.towAttachmentSelf, this.towAttachmentOther, this.towConstraintZOffset);
                  }
               }
            }
         }
   ...
   private static final class EngineRPMData {
   ...
   public static final class ModelInfo {
      ...
      public AnimationPlayer getAnimationPlayer() {
         String var1 = this.scriptModel.file;
         Model var2 = ModelManager.instance.getLoadedModel(var1);
         if (var2 != null && !var2.bStatic) {
            if (this.m_animPlayer != null && this.m_animPlayer.getModel() != var2) {
               this.m_animPlayer = (AnimationPlayer)Pool.tryRelease(this.m_animPlayer);
