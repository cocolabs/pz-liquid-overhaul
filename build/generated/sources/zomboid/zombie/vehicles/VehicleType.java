...
public final class VehicleType {
   ...
   public static final HashMap specialVehicles = new HashMap();
   ...
   private static void initNormal() {
      ...
      while(var2.hasNext()) {
         ...
         if (var7.delegate.containsKey("randomAngle")) {
            var5.randomAngle = var7.rawgetBool("burrandomAnglentCar");
         }
   ...
   public static VehicleType getRandomVehicleType(String var0, Boolean var1) {
      ...
      if (var2 == null) {
         ...
         if (!var2.isBurntCar && !var2.isSpecialCar && Rand.Next(100) < var2.chanceToSpawnSpecial) {
            String var3 = (String)specialVehicles.keySet().toArray()[Rand.Next(0, specialVehicles.keySet().toArray().length)];
            var2 = (VehicleType)specialVehicles.get(var3);
         }
