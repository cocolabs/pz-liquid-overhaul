...
public final class CollideWithObstacles {
   ...
   Vector2f resolveCollision(IsoGameCharacter var1, float var2, float var3, Vector2f var4) {
      ...
      if (var1.getCurrentSquare() != null && var1.getCurrentSquare().HasStairs()) {
         ...
         boolean var5 = Core.bDebug && DebugOptions.instance.CollideWithObstaclesRender.getValue();
         float var6 = var1.x;
         float var7 = var1.y;
         float var8 = var2;
         float var9 = var3;
         ...
         if (var6 == var2 && var7 == var3) {
            ...
            if (var5) {
               ...
               while(var38.hasNext()) {
                  ...
                  if (var37.getNormalAndEdgeVectors(this.nodeNormal, this.edgeVec)) {
            ...
            int var16;
            CollideWithObstacles.CCEdge var17;
            for(int var14 = 0; var14 < this.obstacles.size(); ++var14) {
               ...
               if (var15.isPointInPolygon_WindingNumber(var1.x, var1.y)) {
                  for(var16 = 0; var16 < var15.edges.size(); ++var16) {
                     var17 = (CollideWithObstacles.CCEdge)var15.edges.get(var16);
                     if (var17.node1.visible.contains(var17.node2)) {
                        CollideWithObstacles.CCNode var18 = var17.closestPoint(var1.x, var1.y, this.closest);
                        double var19 = (double)((var1.x - this.closest.x) * (var1.x - this.closest.x) + (var1.y - this.closest.y) * (var1.y - this.closest.y));
                        if (var19 < var41) {
                           var41 = var19;
                           var39 = var17;
                           var37 = var18;
            ...
            if (var39 == null) {
               ...
               for(var16 = 0; var16 < this.obstacles.size(); ++var16) {
                  CollideWithObstacles.CCObstacle var47 = (CollideWithObstacles.CCObstacle)this.obstacles.get(var16);
                  ...
                  for(int var50 = 0; var50 < var47.edges.size(); ++var50) {
                     ...
                     if (var52.node1.visible.contains(var52.node2)) {
                        float var20 = var52.node1.x;
                        float var21 = var52.node1.y;
                        float var22 = var52.node2.x;
                        float var23 = var52.node2.y;
                        float var24 = var20 + 0.5F * (var22 - var20);
                        float var25 = var21 + 0.5F * (var23 - var21);
                        if (var5) {
                           LineDrawer.addLine(var24, var25, (float)var52.node1.z, var24 + var52.normal.x, var25 + var52.normal.y, (float)var52.node1.z, 0.0F, 0.0F, 1.0F, (String)null, true);
                        }

                        double var26 = (double)((var23 - var21) * (var8 - var6) - (var22 - var20) * (var9 - var7));
                        if (var26 != 0.0D) {
                           double var28 = (double)((var22 - var20) * (var7 - var21) - (var23 - var21) * (var6 - var20)) / var26;
                           double var30 = (double)((var8 - var6) * (var7 - var21) - (var9 - var7) * (var6 - var20)) / var26;
                           float var32 = var52.normal.dot(this.move);
                           if (!(var32 >= 0.0F) && var28 >= 0.0D && var28 <= 1.0D && var30 >= 0.0D && var30 <= 1.0D) {
                              if (var30 < 0.01D || var30 > 0.99D) {
                                 CollideWithObstacles.CCNode var33 = var30 < 0.01D ? var52.node1 : var52.node2;
                              ...
                              float var53 = (float)((double)var6 + var28 * (double)(var8 - var6));
                              float var34 = (float)((double)var7 + var28 * (double)(var9 - var7));
                              double var35 = (double)IsoUtils.DistanceToSquared(var6, var7, var53, var34);
                              if (var35 < var43) {
                                 var43 = var35;
                                 var39 = var52;
                              }
            ...
            if (var37 != null) {
               ...
               for(var16 = 0; var16 < var37.edges.size(); ++var16) {
                  var17 = (CollideWithObstacles.CCEdge)var37.edges.get(var16);
                  if (var17.node1.visible.contains(var17.node2) && var17 != var39 && (var45.node1.x != var17.node1.x || var45.node1.y != var17.node1.y || var45.node2.x != var17.node2.x || var45.node2.y != var17.node2.y) && (var45.node1.x != var17.node2.x || var45.node1.y != var17.node2.y || var45.node2.x != var17.node1.x || var45.node2.y != var17.node1.y) && (!var45.hasNode(var17.node1) || !var45.hasNode(var17.node2))) {
                     var44 = var17;
                  }
               }
            ...
            if (var39 != null) {
               ...
               float var48 = var39.node2.y;
               if (var5) {
                  LineDrawer.addLine(var42, var46, (float)var39.node1.z, var51, var48, (float)var39.node1.z, 0.0F, 1.0F, 1.0F, (String)null, true);
               }
