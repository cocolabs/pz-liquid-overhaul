...
public final class ZControllerEvent {
   ...
   ZControllerEvent(ZInputController var1, long var2, int var4, int var5, boolean var6, boolean var7) {
      this(var1, var2, var4, var5, false, var6, var7, 0.0F, 0.0F);
   }

   ZControllerEvent(ZInputController var1, long var2, int var4, int var5, boolean var6, boolean var7, boolean var8, float var9, float var10) {
      this.source = var1;
      this.timeStamp = var2;
      this.type = var4;
      this.index = var5;
   ...
   public ZInputController getSource() {
      return this.source;
   }
