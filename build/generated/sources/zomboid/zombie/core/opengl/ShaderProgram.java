...
public final class ShaderProgram {
   ...
   private void onCompileSuccess() {
      if (this.isCompiled()) {
         ...
         int var2 = GL20.glGetProgram(var1, 35718);
         int var3 = 0;

         for(int var4 = 0; var4 < var2; ++var4) {
            String var5 = GL20.glGetActiveUniform(var1, var4, 255);
            int var6 = GL20.glGetUniformLocation(var1, var5);
            if (var6 != -1) {
               int var7 = GL20.glGetActiveUniformSize(var1, var4);
               int var8 = GL20.glGetActiveUniformType(var1, var4);
               ShaderProgram.Uniform var9 = new ShaderProgram.Uniform();
               this.uniformsByName.put(var5, var9);
               var9.name = var5;
               var9.loc = var6;
               var9.size = var7;
               var9.type = var8;
               if (DebugLog.isEnabled(DebugType.Shader)) {
                  DebugLog.Shader.debugln(var5 + ", Loc: " + var6 + ", Type: " + var8 + ", Size: " + var7);
               }

               if (var9.type == 35678) {
                  if (var3 != 0) {
                     GL20.glUniform1i(var9.loc, var3);
                  }
   ...
   void setTransformMatrix(int var1, Matrix4f var2) {
      ...
      floatBuffer.flip();
      ARBShaderObjects.glUniformMatrix4ARB(var1, true, floatBuffer);
   }
