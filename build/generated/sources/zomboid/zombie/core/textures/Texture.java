...
public class Texture extends Asset implements IDestroyable, ITexture, Serializable {
   ...
   public static Texture getWhite() {
      if (white == null) {
         ...
         RenderThread.invokeOnRenderContext(() -> {
            ...
            ByteBuffer var0 = ByteBuffer.allocateDirect(white.width * white.height * 4);
   ...
   public static Texture getErrorTexture() {
      if (errorTexture == null) {
         ...
         RenderThread.invokeOnRenderContext(() -> {
            ...
            GL11.glTexParameteri(3553, 10240, 9728);
            byte var0 = 4;
            ByteBuffer var1 = ByteBuffer.allocateDirect(errorTexture.width * errorTexture.height * var0);
   ...
   public void renderwallnw(float var1, float var2, float var3, float var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      ...
      float var15 = var2 - (float)(96 * var11) + var4 / 2.0F - 1.0F - 0.0F;
      float var16 = var1 + 0.0F;
      float var17 = var2 - (float)(96 * var11) - 2.0F - 0.0F;
      float var18 = var1 + 0.0F;
      float var19 = var2 + 4.0F + 0.0F;
      float var20 = var1 - var3 / 2.0F - 0.0F;
      float var21 = var2 + var4 / 2.0F + 4.0F + 0.0F;
      SpriteRenderer.instance.render(this, var14, var15, var16, var17, var18, var19, var20, var21, var8, var7, var5, var6);
      if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Walls.LightingOldDebug.getValue()) {
         var10 = -256;
         var9 = -256;
         var7 = -256;
      ...
      var14 = var1 - 0.0F;
      var15 = var2 - (float)(96 * var11) - 0.0F;
      var16 = var1 + var3 / 2.0F + 0.0F;
      var17 = var2 - (float)(96 * var11) + var4 / 2.0F - 0.0F;
      var18 = var1 + var3 / 2.0F + 0.0F;
      var19 = var2 + var4 / 2.0F + 5.0F + 0.0F;
      var20 = var1 - 0.0F;
      var21 = var2 + 5.0F + 0.0F;
      SpriteRenderer.instance.render(this, var14, var15, var16, var17, var18, var19, var20, var21, var7, var10, var9, var5);
   }
   ...
   public void renderwallw(float var1, float var2, float var3, float var4, int var5, int var6, int var7, int var8) {
      ...
      float var14 = var1 + (float)var11 + 0.0F;
      float var15 = var2 - (float)(96 * var11) - 3.0F - 0.0F;
      float var16 = var1 + (float)var11 + 0.0F;
      float var17 = var2 + 3.0F + 0.0F;
   ...
   public void renderwalln(float var1, float var2, float var3, float var4, int var5, int var6, int var7, int var8) {
      ...
      int var11 = Core.TileScale;
      float var12 = var1 - 6.0F - 0.0F;
      float var13 = var2 - (float)(96 * var11) - 3.0F - 0.0F;
      float var14 = var1 + var3 / 2.0F + 0.0F;
      float var15 = var2 - (float)(96 * var11) + var4 / 2.0F - 0.0F;
      float var16 = var1 + var3 / 2.0F + 0.0F;
      float var17 = var2 + var4 / 2.0F + 5.0F + 0.0F;
      float var18 = var1 - 6.0F - 0.0F;
      float var19 = var2 + 2.0F + 0.0F;
      SpriteRenderer.instance.render(this, var12, var13, var14, var15, var16, var17, var18, var19, var7, var8, var6, var5);
   }
