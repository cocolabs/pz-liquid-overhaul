...
public final class TextureCombiner {
   ...
   public Texture combine(Texture var1, Texture var2) throws Exception {
      ...
      GL13.glActiveTexture(33984);
      GL11.glEnable(3553);
      GL11.glBindTexture(3553, var1.getID());
      ...
      GL11.glVertex2d(0.0D, (double)var1.height);
      GL11.glTexCoord2f(1.0F, 1.0F);
      GL11.glVertex2d((double)var1.width, (double)var1.height);
      GL11.glTexCoord2f(1.0F, 0.0F);
      GL11.glVertex2d((double)var1.width, 0.0D);
      GL11.glEnd();
      GL11.glBindTexture(3553, var2.getID());
      GL11.glBegin(7);
      GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
      GL11.glTexCoord2f(0.0F, 0.0F);
      GL11.glVertex2d(0.0D, 0.0D);
   ...
   public Texture combine(ArrayList var1) throws Exception, OpenGLException {
      ...
      for(int var5 = 0; var5 < var1.size(); ++var5) {
         ...
         GL11.glBlendFunc(var6.blendSrc, var6.blendDest);
         if (var6.x != -1) {
            ...
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GL11.glTexCoord2f(0.0F, 1.0F);
            GL11.glVertex2d((double)((float)var6.x * var13), (double)((float)var6.y * var14));
            GL11.glTexCoord2f(0.0F, 0.0F);
            GL11.glVertex2d((double)((float)var6.x * var13), (double)((float)(var6.y + var6.h) * var14));
            GL11.glTexCoord2f(1.0F, 0.0F);
            GL11.glVertex2d((double)((float)(var6.x + var6.w) * var13), (double)((float)(var6.y + var6.h) * var14));
            GL11.glTexCoord2f(1.0F, 1.0F);
            GL11.glVertex2d((double)((float)(var6.x + var6.w) * var13), (double)((float)var6.y * var14));
            GL11.glEnd();
         } else {
            GL11.glBegin(7);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            GL11.glVertex2d(0.0D, 0.0D);
            GL11.glTexCoord2f(0.0F, 0.0F);
            GL11.glVertex2d(0.0D, (double)var3);
            GL11.glTexCoord2f(1.0F, 0.0F);
            GL11.glVertex2d((double)var2, (double)var3);
            GL11.glTexCoord2f(1.0F, 1.0F);
            GL11.glVertex2d((double)var2, 0.0D);
            GL11.glEnd();
         }
   ...
   private static final class CombinerFBO {
      TextureFBO fbo;
      final ArrayDeque textures;

      private CombinerFBO() {
         this.textures = new ArrayDeque();
      }

      // $FF: synthetic method
      CombinerFBO(Object var1) {
         this();
      }
   }
}
