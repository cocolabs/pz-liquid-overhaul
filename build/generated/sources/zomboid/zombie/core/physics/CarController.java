...
public final class CarController {
   ...
   private void control_Forward(float var1) {
      IsoGameCharacter var2 = this.vehicleObject.getDriver();
      boolean var3 = var2 != null && var2.Traits.SpeedDemon.isSet();
      boolean var4 = var2 != null && var2.Traits.SundayDriver.isSet();
      int var5 = this.vehicleObject.getScript().gearRatioCount;
      float var6 = 0.0F;
      boolean var7;
      ...
      var10000.engineSpeed -= Math.min(0.5D * (this.vehicleObject.engineSpeed - (double)var6), 100.0D);
      if (var3) {
         if (var1 < 50.0F) {
            var10000 = this.vehicleObject;
            var10000.engineSpeed -= Math.min(0.06D * (this.vehicleObject.engineSpeed - 7000.0D), (double)(30.0F - var1));
         }
      } else if (var1 < 30.0F) {
         var10000 = this.vehicleObject;
         var10000.engineSpeed -= Math.min(0.02D * (this.vehicleObject.engineSpeed - 7000.0D), (double)(30.0F - var1));
      }
   ...
   private void control_Reverse(float var1) {
      ...
      float var5 = 3000.0F * var1 / 30.0F;
      BaseVehicle var10000 = this.vehicleObject;
      var10000.engineSpeed -= Math.min(0.5D * (this.vehicleObject.engineSpeed - (double)var5), 100.0D);
      if (var3) {
         var10000 = this.vehicleObject;
         var10000.engineSpeed -= Math.min(0.06D * (this.vehicleObject.engineSpeed - 7000.0D), (double)(30.0F - var1));
      } else {
   ...
   protected boolean shouldBeActive() {
      if (this.vehicleObject.physicActiveCheck != -1L) {
         ...
         BaseVehicle var1 = this.vehicleObject.getVehicleTowedBy();
         if (var1 == null) {
            return Math.abs(this.EngineForce) > 0.01F;
         } else {
