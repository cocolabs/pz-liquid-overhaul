   ...
   private void buildLogString() {
      ...
      if (var3 == 0) {
         ...
         while(var1.hasPrevious()) {
            AnimatorDebugMonitor.MonitorLogLine var7 = (AnimatorDebugMonitor.MonitorLogLine)var1.previous();
            if (this.logFlags[var7.type.value()]) {
               var8.append(" <TEXT> ");
               if (this.doTickStamps) {
                  var8.append("[");
                  var8.append(String.format("%010d", var7.tick));
                  var8.append("]");
               }

               if (var7.color != null) {
                  var8.append(" <RGB:");
                  var8.append(var7.color.r);
                  var8.append(",");
                  var8.append(var7.color.g);
                  var8.append(",");
                  var8.append(var7.color.b);
                  var8.append("> ");
               }

               var8.append(var7.line);
               var8.append(" <LINE> ");
            }
         }

         this.logString = var8.toString();
