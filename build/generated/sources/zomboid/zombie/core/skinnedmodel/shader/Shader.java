...
public final class Shader {
   ...
   public void setMatrixPalette(FloatBuffer var1, boolean var2) {
      if (!this.bStatic) {
         ARBShaderObjects.glUniformMatrix4ARB(this.MatrixID, var2, var1);
      }
   }
   ...
   public void setLight(int var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, IsoMovingObject var13) {
      ...
      if (var5 + var6 + var7 != 0.0F && !(var8 <= 0.0F)) {
         ...
         if (!Float.isNaN(var9)) {
            ...
            var19 = var16.x;
            float var20 = var16.y;
            var16.x = (float)((double)var19 * Math.cos((double)var18) - (double)var20 * Math.sin((double)var18));
            var16.y = (float)((double)var19 * Math.sin((double)var18) + (double)var20 * Math.cos((double)var18));
         }
   ...
   public void setTransformMatrix(Matrix4f var1, boolean var2) {
      ...
      floatBuffer.flip();
      ARBShaderObjects.glUniformMatrix4ARB(this.TransformMatrixID, var2, floatBuffer);
   }
   ...
   public void setTransformMatrix(org.joml.Matrix4f var1, boolean var2) {
      ...
      ARBShaderObjects.glUniformMatrix4ARB(this.TransformMatrixID, var2, this.floatBuffer2);
   }
