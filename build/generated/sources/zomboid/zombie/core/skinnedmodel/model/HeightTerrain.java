...
public final class HeightTerrain {
   ...
   public HeightTerrain(int var1, int var2) {
      ...
      for(var12 = 0; var12 < var7; ++var12) {
         for(var13 = 0; var13 < var8; ++var13) {
            ...
            var15.Normal.normalize();
            System.out.println(var15.Normal.x() + " , " + var15.Normal.y() + ", " + var15.Normal.z());
            var15.Normal.normalize();
            ++var27;
         }
      }
   ...
   private void doLighting() {
      ...
      GL11.glLight(16384, 4608, (FloatBuffer)temp.asFloatBuffer().put(lightAmbient).flip());
      GL11.glLight(16384, 4609, (FloatBuffer)temp.asFloatBuffer().put(lightDiffuse).flip());
      GL11.glLight(16384, 4611, (FloatBuffer)temp.asFloatBuffer().put(lightPosition).flip());
      ...
      specular[2] = 0.0F;
      specular[3] = 0.0F;
      GL11.glMaterial(1032, 4610, (FloatBuffer)temp.asFloatBuffer().put(specular).flip());
      GL11.glMaterial(1032, 5633, (FloatBuffer)temp.asFloatBuffer().put(specular).flip());
      GL11.glMaterial(1032, 5632, (FloatBuffer)temp.asFloatBuffer().put(specular).flip());
      ambient[0] = 0.6F;
      ambient[1] = 0.6F;
      ambient[2] = 0.6F;
      ambient[3] = 1.0F;
      ...
      diffuse[2] = 0.6F;
      diffuse[3] = 0.6F;
      GL11.glMaterial(1032, 4608, (FloatBuffer)temp.asFloatBuffer().put(ambient).flip());
      GL11.glMaterial(1032, 4609, (FloatBuffer)temp.asFloatBuffer().put(diffuse).flip());
   }
}
