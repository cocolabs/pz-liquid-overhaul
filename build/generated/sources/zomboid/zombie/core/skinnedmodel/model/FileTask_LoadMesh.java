...
public class FileTask_LoadMesh extends FileTask_AbstractLoadModel {
   ...
   public ProcessedAiScene loadFBX() throws IOException {
      ...
      Vector4f var8 = new Vector4f(1.0F, 0.0F, 0.0F, -1.5707964F);
      var6.setFromAxisAngle(var8);
      ProcessedAiSceneParams var9 = ProcessedAiSceneParams.create();
      var9.scene = var2;
      var9.mode = var3;
      var9.skinnedTo = var5;
      var9.meshName = this.getMeshName();
      var9.animBonesScaleModifier = 0.01F;
      var9.animBonesRotateModifier = var6;
      ProcessedAiScene var10 = ProcessedAiScene.process(var9);
      JAssImpImporter.takeOutTheTrash(var2);
      return var10;
   }
