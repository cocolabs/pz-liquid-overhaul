...
public final class VertexBufferObject {
   ...
   private VertexBufferObject.Vbo LoadVBO(VertexBufferObject.VertexArray var1, int[] var2) {
      VertexBufferObject.Vbo var3 = new VertexBufferObject.Vbo();
      var3.FaceDataOnly = false;
      ByteBuffer var4 = BufferUtils.createByteBuffer(var2.length * 4);
         ...
         if (!DebugOptions.instance.DebugDraw_SkipVBODraw.getValue()) {
            ...
            if (!var0.FaceDataOnly) {
               ...
               for(var6 = 0; var6 < var1.m_elements.length; ++var6) {
                  ...
                  switch(var7.m_type) {
                  case VertexArray:
                     GL11.glVertexPointer(3, 5126, var0.VertexStride, (long)var7.m_byteOffset);
                     GL11.glEnableClientState(32884);
                     break;
                  case NormalArray:
                     GL11.glNormalPointer(5126, var0.VertexStride, (long)var7.m_byteOffset);
                     GL11.glEnableClientState(32885);
                     break;
                  case ColorArray:
                     GL11.glColorPointer(3, 5121, var0.VertexStride, (long)var7.m_byteOffset);
                     GL11.glEnableClientState(32886);
                     break;
                  case TextureCoordArray:
                     GL13.glActiveTexture(var4);
                     GL13.glClientActiveTexture(var4);
                     GL11.glTexCoordPointer(2, 5126, var0.VertexStride, (long)var7.m_byteOffset);
                     ++var4;
            ...
            GL11.glDrawElements(var3, var0.NumElements, 5125, 0L);
