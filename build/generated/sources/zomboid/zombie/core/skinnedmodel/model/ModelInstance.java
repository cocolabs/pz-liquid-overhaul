            ...
            if (var1.getCurrentSquare() != null) {
               ...
               if (var1.z - (float)((int)var1.z) > 0.2F) {
                  ...
                  if (var15 != null) {
                     ...
                     var15.interpolateLight(var16, var1.x % 1.0F, var1.y % 1.0F);
                     ModelInstance.tempColorInfo.interp(var16, (var1.z - ((float)((int)var1.z) + 0.2F)) / 0.8F, ModelInstance.tempColorInfo);
               ...
               for(int var7 = 0; var7 < 5; ++var7) {
                  ...
                  if (var8 != null && var8.active) {
                     ...
                     if ((var8.flags & 1) != 0) {
                        var9.set(var1.x, var1.y, (float)((int)var1.z + 1), var8.currentColor.x * var18, var8.currentColor.y * var18, var8.currentColor.z * var18, var8.radius);
               ...
               float var11 = this.lerp(var19, var20, this.currentAmbient.z);
               if (var1.getCurrentSquare().isOutside()) {
                  ...
                  var11 *= ModelInstance.MODEL_LIGHT_MULT_OUTSIDE;
                  this.effectLightsMain[3].set(var1.x - 2.0F, var1.y - 2.0F, var1.z + 1.0F, var21 / 4.0F, var10 / 4.0F, var11 / 4.0F, 5000);
                  this.effectLightsMain[4].set(var1.x + 2.0F, var1.y + 2.0F, var1.z + 1.0F, var21 / 4.0F, var10 / 4.0F, var11 / 4.0F, 5000);
                  ...
                  var11 *= ModelInstance.MODEL_LIGHT_MULT_ROOM;
                  this.effectLightsMain[3].set(var1.x - 2.0F, var1.y - 2.0F, var1.z + 1.0F, var21 / 4.0F, var10 / 4.0F, var11 / 4.0F, 5000);
                  this.effectLightsMain[4].set(var1.x + 2.0F, var1.y + 2.0F, var1.z + 1.0F, var21 / 4.0F, var10 / 4.0F, var11 / 4.0F, 5000);
               }
