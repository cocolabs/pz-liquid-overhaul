...
public final class ModelInstanceTextureCreator extends TextureDraw.GenericDrawer {
   ...
   public void init(HumanVisual var1, ItemVisuals var2, ModelInstance var3) {
      ...
      for(var21 = 0; var21 < BloodBodyPartType.MAX.index(); ++var21) {
         ...
         String var25 = "media/textures/BloodTextures/" + CharacterSmartTexture.MaskFiles[var23.index()] + ".png";
         var18 = Texture.getSharedTexture(var25);
         if (var18 != null && !var18.isReady()) {
            this.texturesNotReady.add(var18);
         }

         var12 = "media/textures/HoleTextures/" + CharacterSmartTexture.MaskFiles[var23.index()] + ".png";
         var18 = Texture.getSharedTexture(var12);
         if (var18 != null && !var18.isReady()) {
            this.texturesNotReady.add(var18);
         }

         var29 = "media/textures/patches/" + CharacterSmartTexture.BasicPatchesMaskFiles[var23.index()] + ".png";
         var18 = Texture.getSharedTexture(var29);
         if (var18 != null && !var18.isReady()) {
            this.texturesNotReady.add(var18);
         }

         String var31 = "media/textures/patches/" + CharacterSmartTexture.DenimPatchesMaskFiles[var23.index()] + ".png";
         var18 = Texture.getSharedTexture(var31);
         if (var18 != null && !var18.isReady()) {
            this.texturesNotReady.add(var18);
         }

         String var32 = "media/textures/patches/" + CharacterSmartTexture.LeatherPatchesMaskFiles[var23.index()] + ".png";
   ...
   private void addClothingItem(ModelInstance var1, ItemVisual var2, ClothingItem var3, CharacterMask var4, String var5) {
      ...
      Texture var10 = Texture.getSharedTexture(var9.baseTexture);
      if (var10 != null && !var10.isReady()) {
         this.texturesNotReady.add(var10);
      }

      String var11;
      if (!var9.mask.isAllVisible() && !var9.mask.isNothingVisible()) {
         var11 = var9.maskFolder;
         Consumer var12 = Lambda.consumer(var11, this.texturesNotReady, (var0, var1x, var2x) -> {
            Texture var3 = Texture.getSharedTexture(var1x + "/" + var0 + ".png");
            if (var3 != null && !var3.isReady()) {
               var2x.add(var3);
            }
         ...
         var9.mask.forEachVisible(var12);
      }

      if (Core.getInstance().isOptionSimpleClothingTextures(this.bZombie)) {
         this.itemData.add(var9);
      } else {
         var11 = var2.getDecal(var3);
         if (!StringUtils.isNullOrWhitespace(var11)) {
            ClothingDecal var15 = ClothingDecals.instance.getDecal(var11);
            if (var15 != null && var15.isValid()) {
               var9.decalTexture = var15.texture;
               var9.decalX = var15.x;
               var9.decalY = var15.y;
               var9.decalWidth = var15.width;
               var9.decalHeight = var15.height;
               var10 = Texture.getSharedTexture("media/textures/" + var9.decalTexture + ".png");
               if (var10 != null && !var10.isReady()) {
                  this.texturesNotReady.add(var10);
               }
            }
         ...
         for(int var16 = 0; var16 < BloodBodyPartType.MAX.index(); ++var16) {
            BloodBodyPartType var13 = BloodBodyPartType.FromIndex(var16);
            var9.blood[var16] = var2.getBlood(var13);
            var9.dirt[var16] = var2.getDirt(var13);
            var9.basicPatches[var16] = var2.getBasicPatch(var13);
            var9.denimPatches[var16] = var2.getDenimPatch(var13);
            var9.leatherPatches[var16] = var2.getLeatherPatch(var13);
            var9.hole[var16] = var2.getHole(var13);
            if (var9.hole[var16] > 0.0F) {
               String var14 = "media/textures/HoleTextures/" + CharacterSmartTexture.MaskFiles[var13.index()] + ".png";
               var10 = Texture.getSharedTexture(var14);
               if (var10 != null && !var10.isReady()) {
                  this.texturesNotReady.add(var10);
               }
            }

            if (var9.hole[var16] == 0.0F && this.holeMask[var16]) {
               var9.hole[var16] = -1.0F;
               if (var9.mask.isBloodBodyPartVisible(var13)) {
               }
            }
         }
   ...
   public void render() {
      if (!this.bRendered) {
         ...
         try {
            ...
            int var10;
            for(var10 = this.itemData.size() - 1; var10 >= 0; --var10) {
               ...
               if (this.isSimpleTexture(var3)) {
                  var4 = Texture.getSharedTexture(var3.baseTexture);
                  if (!this.isItemSmartTextureRequired(var3)) {
                     var3.modelInstance.tex = var4;
                     continue;
                  }
               } else {
                  ItemSmartTexture var5 = this.createFullItemTexture(var3);

                  assert var5 == this.itemSmartTexture;

                  var4 = var5.result;
                  this.tempTextures.add(var5.result);
                  var5.result = null;
               }
            ...
            for(var10 = 0; var10 < this.tempTextures.size(); ++var10) {
               for(int var11 = 0; var11 < this.itemData.size(); ++var11) {
                  ModelInstance var12 = ((ModelInstanceTextureCreator.ItemData)this.itemData.get(var11)).modelInstance;

                  assert var12 == null || this.tempTextures.get(var10) != var12.tex;
               }
