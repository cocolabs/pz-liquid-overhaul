...
public final class ModelInstanceRenderData {
   ...
   public ModelInstanceRenderData init(ModelInstance var1) {
      ...
      VehicleSubModelInstance var6 = (VehicleSubModelInstance)Type.tryCastTo(var1, VehicleSubModelInstance.class);
      if (var1 instanceof VehicleModelInstance || var6 != null) {
         if (var1 instanceof VehicleModelInstance) {
            this.xfrm.set((Matrix4fc)((BaseVehicle)var1.object).renderTransform);
         } else {
            this.xfrm.set((Matrix4fc)var6.modelInfo.renderTransform);
         }
