...
public final class HelperFunctions {
   ...
   public static Matrix4f CreateFromQuaternionPositionScale(Quaternion var0, Vector3f var1, Vector3f var2) {
      Matrix4f var3 = getMatrix();
      CreateFromQuaternionPositionScale(var0, var1, var2, var3);
      return var3;
   }

   public static Matrix4f CreateFromQuaternionPositionScale(Quaternion var0, Vector3f var1, Vector3f var2, Matrix4f var3) {
      Matrix4f var4 = CreateFromQuaternion(var0, getMatrix());
      ...
      var6.scale(var2);
      var5.transpose();
      Matrix4f.mul(var6, var4, var4);
      Matrix4f.mul(var4, var5, var3);
      returnMatrix(var5);
      returnMatrix(var4);
      returnMatrix(var6);
      return var3;
   ...
   public static float getRotationY(Quaternion var0) {
      ...
      float var10 = var3 * 0.0F - var4 * 0.0F;
      float var11 = var2 * 0.0F - var3 * 1.0F;
      float var12 = 1.0F * var2 + 0.0F * var3 + 0.0F * var4;
      float var13 = (var5 - var6) * 1.0F + 2.0F * var1 * var10 + 2.0F * var2 * var12;
      float var14 = (var5 - var6) * 0.0F + 2.0F * var1 * var11 + 2.0F * var4 * var12;
      float var15 = (float)Math.atan2((double)(-var14), (double)var13);
      return PZMath.wrap(var15, -3.1415927F, 3.1415927F);
   }
   ...
   public static float getRotationZ(Quaternion var0) {
      ...
      float var5 = var1 * var1;
      float var6 = var2 * var2 + var3 * var3 + var4 * var4;
      float var8 = var4 * 1.0F;
      float var9 = 1.0F * var2;
      float var10 = (var5 - var6) * 1.0F + 2.0F * var2 * var9;
      float var11 = 2.0F * var1 * var8 + 2.0F * var3 * var9;
