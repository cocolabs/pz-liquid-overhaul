...
public final class AnimationPlayer extends PooledObject {
   ...
   private void interpolateBodyAngle(float var1) {
      ...
      if (PZMath.equal(var2, 0.0F, 0.001F)) {
         ...
         float var5;
         if (DebugOptions.instance.CharacterAnimateDeferredRotationOnly.getValue()) {
   ...
   private void updateTwistBoneInternal() {
      if (!this.m_twistBones.isEmpty()) {
         if (!PZMath.equal(this.m_twistAngle, 0.0F, 1.0E-4F)) {
            if (!DebugOptions.instance.CharacterAnimateNoBoneTwists.getValue()) {
               ...
               for(int var5 = 0; var5 < var2; ++var5) {
                  SkinningBone var6 = ((AnimationBoneBinding)this.m_twistBones.get(var5)).getBone();
                  this.applyTwistBone(var6, var4);
               }

               float var8 = -this.m_twistAngle;
               float var9 = PZMath.getClosestAngle(var3, var8);
               if (PZMath.abs(var9) > 1.0E-4F) {
                  SkinningBone var7 = ((AnimationBoneBinding)this.m_twistBones.get(var2)).getBone();
                  this.applyTwistBone(var7, var9);
               }
   ...
   private void applyTwistBone(SkinningBone var1, float var2) {
      if (var1 != null) {
         ...
         HelperFunctions.CreateFromQuaternionPositionScale(var15, var13, var14, var12);
   ...
   private void updateLayerBlendWeightings() {
      ...
      if (this.m_totalAnimBlendCount != 0) {
         if (this.m_boneTransformsNeedFirstFrame) {
            var10 = this.m_animBlendLayers[0];
            int var11 = this.m_layerBlendCounts[0];
            float var12 = this.m_layerWeightTotals[0];
            if (var12 < 1.0F) {
               for(var7 = 0; var7 < this.m_totalAnimBlendCount; ++var7) {
                  var8 = this.m_animBlendLayers[var7];
                  if (var8 != var10) {
                     break;
                  }
                  ...
                  if (var12 > 0.0F) {
                     ...
                     this.m_animBlendWeights[var7] = 1.0F / (float)var11;
                  }
               }
            }
         }
         ...
         if (!(var17 <= 0.001F)) {
            ...
            if (!(var18 <= 0.001F)) {
               ...
               if (var10 && var16.getUseDeferredRotation()) {
                  Vector3f var20;
                  if (DebugOptions.instance.CharacterAnimateZeroCounterRotationBone.getValue()) {
   ...
   public static Matrix4f getUnweightedBoneTransform(AnimationTrack var0, int var1, Matrix4f var2) {
      ...
      HelperFunctions.CreateFromQuaternionPositionScale(var4, var3, var5, var2);
      return var2;
   }
