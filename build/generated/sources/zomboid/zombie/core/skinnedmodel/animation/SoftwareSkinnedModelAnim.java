   ...
   private void Draw(Vbo var1, VertexStride[] var2, VertexBufferObject.BeginMode var3, Shader var4, int var5, int var6, String var7) {
      ...
      if (!var1.FaceDataOnly) {
         ...
         for(int var10 = var2.length - 1; var10 >= 0; --var10) {
            ...
            case VertexArray:
               GL11.glVertexPointer(3, 5126, var1.VertexStride, (long)var2[var10].Offset);
               GL11.glEnableClientState(32884);
               break;
            case NormalArray:
               GL11.glNormalPointer(5126, var1.VertexStride, (long)var2[var10].Offset);
               GL11.glEnableClientState(32885);
               break;
            case ColorArray:
               GL11.glColorPointer(3, 5121, var1.VertexStride, (long)var2[var10].Offset);
               GL11.glEnableClientState(32886);
               break;
            case TextureCoordArray:
               GL13.glActiveTexture(var9);
               GL13.glClientActiveTexture(var9);
               GL11.glTexCoordPointer(2, 5126, var1.VertexStride, (long)var2[var10].Offset);
               ++var9;
      ...
      GL11.glDrawElements(4, var8, 5125, this.animOffset * 4L);
