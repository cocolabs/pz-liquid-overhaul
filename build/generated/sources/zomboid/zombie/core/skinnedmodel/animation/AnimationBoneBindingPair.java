...
public final class AnimationBoneBindingPair {
   ...
   public String toString() {
      ...
      return this.getClass().getName() + var1 + "{" + var1 + "\t" + "boneBindingA:" + StringUtils.indent(String.valueOf(this.boneBindingA)) + var1 + "\t" + "boneBindingB:" + StringUtils.indent(String.valueOf(this.boneBindingB)) + var1 + "}";
   }
}
