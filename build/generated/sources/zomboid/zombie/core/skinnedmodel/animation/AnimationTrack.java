...
public final class AnimationTrack extends PooledObject {
   ...
   protected AnimationTrack() {
      PZArrayUtil.arrayPopulate(this.m_pose, () -> {
         return new AnimationTrack.KeyframeSpan();
      });
      this.resetInternal();
   }
   ...
   public float getBoneWeight(int var1) {
      if (!this.hasBoneMask()) {
         ...
         return DebugOptions.instance.CharacterAnimateNoBoneMasks.getValue() ? 1.0F : PZArrayUtil.getOrDefault(this.m_boneWeights.array(), var1, 0.0F);
      }
   }
   ...
   private static class DeferredMotionData {
      ...
      // $FF: synthetic method
      DeferredMotionData(Object var1) {
         this();
      }
   }
