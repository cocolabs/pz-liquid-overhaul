      ...
      for(Matrix4f var7 = new Matrix4f(); (float)var6 < var1; ++var6) {
         ...
         for(int var8 = 0; var8 < 60; ++var8) {
            if (this.Pose[var8] == null) {
               ...
               Matrix4f var11 = HelperFunctions.CreateFromQuaternionPositionScale(var9, var10, new Vector3f(1.0F, 1.0F, 1.0F), new Matrix4f());
   ...
   public void doRootMotion(List var1) {
      ...
      if (var1.size() > 3) {
         for(int var3 = 0; (float)var3 < var2 && var3 < var1.size(); ++var3) {
            ...
            Matrix4f var7 = HelperFunctions.CreateFromQuaternionPositionScale(var5, var6, var4.Scale, new Matrix4f());
