   ...
   public void render() {
      if (!this.RenderJobs.isEmpty()) {
         for(int var1 = 0; var1 < this.RenderJobs.size(); ++var1) {
            DeadBodyAtlas.RenderJob var2 = (DeadBodyAtlas.RenderJob)this.RenderJobs.get(var1);
            if (var2.done != 1 || var2.renderRefCount <= 0) {
               if (var2.done == 1 && var2.renderRefCount == 0) {
                  this.RenderJobs.remove(var1--);

                  assert !JobPool.contains(var2);
