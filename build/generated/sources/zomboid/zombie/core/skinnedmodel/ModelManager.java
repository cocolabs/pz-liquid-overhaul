...
public final class ModelManager {
   ...
   private void loadAnimsFromDir(String var1, ModelMesh var2) {
      ...
      this.loadAnimsFromDir(var3, var2);
   }

   private void loadAnimsFromDir(File var1, ModelMesh var2) {
      if (!var1.exists()) {
         DebugLog.General.error("ERROR: %s", var1.getPath());

         for(File var3 = var1.getParentFile(); var3 != null; var3 = var3.getParentFile()) {
            DebugLog.General.error(" - Parent exists: %B, %s", var3.exists(), var3.getPath());
         }
      }
      ...
      if (var1.isDirectory()) {
         ...
         if (var10 != null) {
            ...
            for(int var7 = 0; var7 < var6; ++var7) {
               File var8 = var5[var7];
               if (var8.isDirectory()) {
                  this.loadAnimsFromDir(var8, var2);
               } else {
                  String var9 = ZomboidFileSystem.instance.getAnimName(var8);
                  this.loadAnim(var9, var2);
                  var4 = true;
            ...
            if (var4) {
               DebugFileWatcher.instance.add((new ModelManager.AnimDirReloader(var1.getPath(), var2)).GetFileWatcher());
            }
      ...
      if (this.m_bCreated) {
         if (var1.isSceneCulled()) {
            if (this.ToRemove.contains(var1)) {
               ...
               int var4;
               for(var4 = 0; var4 < var2.sub.size(); ++var4) {
               ...
               if (var1 instanceof IsoZombie) {
                  for(var4 = 0; var4 < 4; ++var4) {
                     IsoPlayer var8 = IsoPlayer.players[var4];
                     boolean var6 = true;
                     if (var8 == null) {
                        var6 = false;
                     } else {
                        if (var1.getCurrentSquare() == null || !var1.getCurrentSquare().isCanSee(var4)) {
                           var6 = false;
                        }

                        if (var8.isSeeEveryone()) {
                           var6 = true;
                        }
                     }

                     var1.alpha[var4] = var6 ? 1.0F : 0.0F;
                     var1.targetAlpha[var4] = var1.alpha[var4];
                  }
               }
   ...
   public void update() {
      ...
      for(var1 = 0; var1 < this.m_torches.size(); ++var1) {
         IsoGameCharacter.TorchInfo var5 = (IsoGameCharacter.TorchInfo)this.m_torches.get(var1);
         IsoLightSource var3 = this.m_freeLights.isEmpty() ? new IsoLightSource(0, 0, 0, 1.0F, 1.0F, 1.0F, 1) : (IsoLightSource)this.m_freeLights.pop();
         var3.x = (int)var5.x;
         var3.y = (int)var5.y;
         var3.z = (int)var5.z;
         var3.r = 1.0F;
         var3.g = 0.85F;
         var3.b = 0.6F;
         var3.radius = (int)Math.ceil((double)var5.dist);
         this.m_torchLights.add(var3);
      }
   ...
   private String createModelKey(String var1, String var2, boolean var3, String var4) {
      ...
      if (var1 == null) {
         ...
         if (!toLowerKeyRoot.containsKey(var1)) {
            toLowerKeyRoot.put(var1, var1.toLowerCase().trim());
         }
   ...
   private AnimationAsset loadAnim(String var1, ModelMesh var2) {
      DebugLog.Animation.debugln("Adding asset to queue: %s", var1);
      AnimationAsset.AnimationAssetParams var3 = new AnimationAsset.AnimationAssetParams();
      var3.animationsMesh = var2;
      AnimationAsset var4 = (AnimationAsset)AnimationAssetManager.instance.load(new AssetPath(var1), var3);
      this.putAnimationAsset(var1, var4);
      return var4;
   }

   private void putAnimationAsset(String var1, AnimationAsset var2) {
      String var3 = var1.toLowerCase();
      AnimationAsset var4 = (AnimationAsset)this.m_animationAssets.getOrDefault(var3, (Object)null);
      if (var4 != null) {
         DebugLog.Animation.debugln("Overwriting asset: %s", this.animAssetToString(var4));
         DebugLog.Animation.debugln("New asset        : %s", this.animAssetToString(var2));
      }

      this.m_animationAssets.put(var3, var2);
   }
   ...
   class AnimDirReloader implements PredicatedFileWatcher.IPredicatedFileWatcherCallback {
      ...
      public AnimDirReloader(String var2, ModelMesh var3) {
         var2 = ZomboidFileSystem.instance.getRelativeFile(var2);
         this.m_dir = ZomboidFileSystem.instance.normalizeFolderPath(var2);
         if (this.m_dir.contains("/anims/")) {
            this.m_dirSecondary = this.m_dir.replace("/anims/", "/anims_X/");
         }

         this.m_animationsModel = var3;
      }
      ...
      public void call(String var1) {
         ...
         if (var2.endsWith(".fbx") || var2.endsWith(".x") || var2.endsWith(".txt")) {
            String var3 = ZomboidFileSystem.instance.getAnimName(new File(ZomboidFileSystem.instance.base, var1));
            ...
            if (var4 != null) {
               ...
               ModelManager.this.loadAnim(var3, this.m_animationsModel);
            }
         }
      }
