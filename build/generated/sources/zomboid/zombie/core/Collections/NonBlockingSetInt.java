...
public class NonBlockingSetInt extends AbstractSet implements Serializable {
   ...
   private static final class NBSI {
      ...
      private void print(int var1) {
         ...
         while(var3 != null) {
            for(int var4 = 0; var4 < var3._bits.length; ++var4) {
               System.out.print(Long.toHexString(var3._bits[var4]) + " ");
            }
      ...
      // $FF: synthetic method
      NBSI(int var1, Counter var2, NonBlockingSetInt var3, Object var4) {
         this(var1, var2, var3);
      }

      // $FF: synthetic method
      NBSI(NonBlockingSetInt.NBSI var1, NonBlockingSetInt.NBSI var2, Counter var3, NonBlockingSetInt var4, Object var5) {
