...
public final class DebugChunkState extends GameState {
   ...
   public void renderScene() {
      ...
      if (this.ZoneRect.getValue()) {
         IsoMetaGrid.Zone var4 = IsoWorld.instance.MetaGrid.getZoneAt(this.gridX, this.gridY, this.m_z);
         if (var4 != null) {
      ...
      if (this.BuildingRect.getValue()) {
         ...
         if (var5 != null && var5.getBuilding() != null) {
            BuildingDef var7 = var5.getBuilding().getDef();
            this.DrawIsoLine((float)var7.getX(), (float)var7.getY(), (float)var7.getX2(), (float)var7.getY(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var7.getX2(), (float)var7.getY(), (float)var7.getX2(), (float)var7.getY2(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var7.getX2(), (float)var7.getY2(), (float)var7.getX(), (float)var7.getY2(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var7.getX(), (float)var7.getY2(), (float)var7.getX(), (float)var7.getY(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
         }
      }
      ...
      if (this.RoomLightRects.getValue()) {
         ...
         for(var2 = 0; var2 < var6.size(); ++var2) {
            IsoRoomLight var8 = (IsoRoomLight)var6.get(var2);
            if (var8.z == this.m_z) {
               this.DrawIsoRect((float)var8.x, (float)var8.y, (float)var8.width, (float)var8.height, 0.0F, 1.0F, 1.0F, 1.0F, 1);
            }
         }
      }
   ...
   private void drawCursor() {
      ...
      if (Math.abs(this.gridX - (int)IsoCamera.CamCharacter.x) <= 1 && Math.abs(this.gridY - (int)IsoCamera.CamCharacter.y) <= 1) {
