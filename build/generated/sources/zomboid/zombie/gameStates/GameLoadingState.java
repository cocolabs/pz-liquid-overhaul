...
public final class GameLoadingState extends GameState {
   ...
   public void enter() {
      ...
      File var1 = new File(ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator + Core.GameSaveWorld);
      ...
      convertingFileMax = -1;
      File var3 = ZomboidFileSystem.instance.getFileInCurrentSave("map_ver.bin");
      if (var3.exists()) {
         newGame = false;
      }
      ...
      loader = new Thread(ThreadGroups.Workers, new Runnable() {
         ...
         private void runInner() throws Exception {
            ...
            boolean var1 = (new File(ZomboidFileSystem.instance.getGameModeCacheDir() + File.separator)).mkdir();
            ...
            if (GameWindow.bServerDisconnected) {
               ...
               if (!GameLoadingState.build23Stop) {
                  ...
                  if (!GameServer.bServer) {
                     ...
                     if (var3 || IsoWorld.SavedWorldVersion != 175) {
                        if (!var3 && IsoWorld.SavedWorldVersion != 175) {
