      ...
      public boolean load(PlayerDB.PlayerData var1) throws Exception {
         ...
         if (this.m_conn == null) {
            ...
            try {
               ...
               InputStream var6 = var5.getBinaryStream(1);
               var1.setBytes(var6);
               var1.m_WorldVersion = var5.getInt(2);
               var1.m_x = (float)var5.getInt(3);
               var1.m_y = (float)var5.getInt(4);
               var1.m_z = (float)var5.getInt(5);
               var1.m_isDead = var5.getBoolean(6);
               var1.m_name = var5.getString(7);
               var7 = true;
      ...
      public boolean loadEverythingExceptBytes(PlayerDB.PlayerData var1) throws Exception {
         if (this.m_conn == null) {
            ...
            try {
               ...
               var1.m_WorldVersion = var5.getInt(1);
               var1.m_x = (float)var5.getInt(2);
               var1.m_y = (float)var5.getInt(3);
               var1.m_z = (float)var5.getInt(4);
               var1.m_isDead = var5.getBoolean(5);
               var1.m_name = var5.getString(6);
               var6 = true;
            } catch (Throwable var16) {
               var4 = var16;
               throw var16;
         ...
         if (this.m_conn != null && var1.m_sqlID >= 1) {
            ...
            try {
               ...
               try {
                  ...
                  ByteBuffer var5 = var1.m_byteBuffer;
                  var5.rewind();
                  var3.setBinaryStream(7, new ByteBufferBackedInputStream(var5), var5.remaining());
