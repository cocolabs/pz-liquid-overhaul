...
public final class ZombieGetUpState extends State {
   ...
   public void enter(IsoGameCharacter var1) {
      ...
      var2.put(PARAM_STANDING, Boolean.FALSE);
      State var3 = var1.getStateMachine().getPrevious();
      if (var3 == ZombieGetUpFromCrawlState.instance()) {
         var3 = (State)var1.getStateMachineParams(ZombieGetUpFromCrawlState.instance()).get(1);
      }

      var2.put(PARAM_PREV_STATE, var3);
   }
