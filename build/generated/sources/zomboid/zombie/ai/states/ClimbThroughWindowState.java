...
public final class ClimbThroughWindowState extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (!this.isWindowClosing(var1)) {
         ...
         } else if (var1.getVariableBoolean("ClimbWindowStarted")) {
         ...
         if (var1 instanceof IsoPlayer && !var1.getVariableBoolean("ClimbWindowEnd") && !"fallfront".equals(var4) && !"back".equals(var4) && !"fallback".equals(var4)) {
            int var15 = (Integer)var2.get(PARAM_OPPOSITE_X);
            int var16 = (Integer)var2.get(PARAM_OPPOSITE_Y);
            int var10 = (Integer)var2.get(PARAM_Z);
            IsoGridSquare var11 = IsoWorld.instance.CurrentCell.getGridSquare(var15, var16, var10);
            if (var11 != null) {
