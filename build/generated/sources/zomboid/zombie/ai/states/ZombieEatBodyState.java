...
public final class ZombieEatBodyState extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (var2.getStateEventDelayTimer() <= 0.0F) {
         ...
         String var4 = var2.isFemale() ? "FemaleZombieEating" : "MaleZombieEating";
         if (!var2.getEmitter().isPlaying(var4)) {
            var2.getEmitter().playSound(var4);
         }
      }
   ...
   public void exit(IsoGameCharacter var1) {
      ...
      String var4 = var2.isFemale() ? "FemaleZombieEating" : "MaleZombieEating";
      var2.getEmitter().stopSoundByName(var4);
   }
}
