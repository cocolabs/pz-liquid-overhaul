         ...
         if (!IsoPlayer.getInstance().pressedMovement(false) && !IsoPlayer.getInstance().pressedCancelAction()) {
            ...
            if (var3 != null && var3.getObjectIndex() != -1) {
               if (IsoPlayer.getInstance().ContextPanic > 5.0F) {
                  ...
                  if (Core.bTutorial) {
                     if (var1.x != var3.getX() + 0.5F && var3.north) {
                        this.slideX(var1, var3.getX() + 0.5F);
                     }

                     if (var1.y != var3.getY() + 0.5F && !var3.north) {
                        this.slideY(var1, var3.getY() + 0.5F);
                     }
                  }
