...
public class BodyDamageSync {
   ...
   public void serverPacket(ByteBuffer var1) {
      ...
      if (var2 == 1) {
         var3 = var1.getShort();
         var4 = var1.getShort();
         noise("PKT_START_UPDATING from " + var4 + " to " + var3);
         ...
         var3 = var1.getShort();
         var4 = var1.getShort();
         noise("PKT_STOP_UPDATING from " + var4 + " to " + var3);
         var5 = (Long)GameServer.IDToAddressMap.get(Integer.valueOf(var4));
         if (var5 != null) {
            var6 = GameServer.udpEngine.getActiveConnection(var5);
            if (var6 != null) {
         ...
         var3 = var1.getShort();
         var4 = var1.getShort();
         noise("PKT_UPDATE from " + var4 + " to " + var3);
         var5 = (Long)GameServer.IDToAddressMap.get(Integer.valueOf(var4));
         if (var5 != null) {
            var6 = GameServer.udpEngine.getActiveConnection(var5);
            if (var6 != null) {
   ...
   public void clientPacket(ByteBuffer var1) {
      ...
      if (var2 == 1) {
         ...
         var3 = var1.getShort();
         var4 = var1.getShort();
         noise("PKT_UPDATE from " + var3 + " " + var1.limit() + " bytes");
