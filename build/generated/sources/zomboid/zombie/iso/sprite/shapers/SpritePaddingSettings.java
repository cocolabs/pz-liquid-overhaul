...
public class SpritePaddingSettings {
   ...
   private static void loadSettings() {
      ...
      if ((new File(var0)).isFile()) {
         try {
            m_settings = (SpritePaddingSettings.Settings)PZXmlUtil.parse(SpritePaddingSettings.Settings.class, var0);
         } catch (PZXmlParserException var2) {
            DebugLog.General.printException(var2, "Error parsing file: " + var0, LogSeverity.Warning);
   ...
   private static void saveSettings() {
      try {
         PZXmlUtil.write((Object)m_settings, new File(getSettingsFilePath()));
