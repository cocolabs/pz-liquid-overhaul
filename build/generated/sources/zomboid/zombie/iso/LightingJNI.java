   ...
   public static void updatePlayer(int var0) {
      ...
      if (var1 != null) {
         ...
         if (var1.getVehicle() == null) {
            ...
            if (var1.Traits.EagleEyed.isSet()) {
               var4 += 0.2F * ClimateManager.getInstance().getDayLightStrength();
            }

            if (var1.Traits.NightVision.isSet()) {
               var4 += 0.2F * (1.0F - ClimateManager.getInstance().getDayLightStrength());
            }
         ...
         for(int var2 = 0; var2 < 10; ++var2) {
            for(int var3 = 0; var3 < 10; ++var3) {
               ...
               if (var4 == null) {
                  ...
                  boolean var15 = var4.Has(IsoObjectType.stairsTN) || var4.Has(IsoObjectType.stairsMN) || var4.Has(IsoObjectType.stairsTW) || var4.Has(IsoObjectType.stairsMW);
                  squareSet(var4.w != null, var4.n != null, var4.e != null, var4.s != null, var15, var5, var4.getRoom() != null ? var4.getBuilding().ID : -1, var4.getRoomID());

                  for(var7 = 0; var7 < var4.getSpecialObjects().size(); ++var7) {
                     IsoObject var16 = (IsoObject)var4.getSpecialObjects().get(var7);
                     if (var16 instanceof IsoCurtain) {
                        IsoCurtain var19 = (IsoCurtain)var16;
                        int var22 = 0;
                        if (var19.getType() == IsoObjectType.curtainW) {
                           var22 |= 4;
                        } else if (var19.getType() == IsoObjectType.curtainN) {
                           var22 |= 8;
                        } else if (var19.getType() == IsoObjectType.curtainE) {
                           var22 |= 16;
                        } else if (var19.getType() == IsoObjectType.curtainS) {
                           var22 |= 32;
                        }

                        squareAddCurtain(var22, var19.open);
                     } else {
                        boolean var10;
                        IsoBarricade var11;
                        IsoBarricade var12;
                        if (!(var16 instanceof IsoDoor)) {
                           if (var16 instanceof IsoThumpable) {
                              IsoThumpable var17 = (IsoThumpable)var16;
                              var10 = var17.getSprite().getProperties().Is("doorTrans");
                              if (var17.isDoor && var17.open) {
                                 var10 = true;
                              }

                              squareAddThumpable(var17.north, var17.open, var17.isDoor, var10);
                              IsoThumpable var20 = (IsoThumpable)var16;
                              boolean var21 = false;
                              IsoBarricade var13 = var20.getBarricadeOnSameSquare();
                              IsoBarricade var14 = var20.getBarricadeOnOppositeSquare();
                              if (var13 != null) {
                                 var21 |= var13.isBlockVision();
                              }

                              if (var14 != null) {
                                 var21 |= var14.isBlockVision();
                              }

                              squareAddWindow(var20.north, var20.open, var21);
                           } else if (var16 instanceof IsoWindow) {
                              IsoWindow var18 = (IsoWindow)var16;
                              var10 = false;
                              var11 = var18.getBarricadeOnSameSquare();
                              var12 = var18.getBarricadeOnOppositeSquare();
                              if (var11 != null) {
                              ...
                              squareAddWindow(var18.north, var18.open, var10);
                           }
                        } else {
                           IsoDoor var9 = (IsoDoor)var16;
