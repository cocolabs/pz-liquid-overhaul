...
public class IsoObject implements Serializable {
   ...
   protected boolean isOutlineHighlight;
   protected boolean isOutlineHlAttached;
   protected boolean isOutlineHlBlink;
   protected ColorInfo outlineHighlightCol;
   ...
   public IsoObject(IsoCell var1) {
      ...
      this.isOutlineHighlight = false;
      this.isOutlineHlAttached = false;
      this.isOutlineHlBlink = false;
      this.outlineHighlightCol = new ColorInfo(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      for(int var5 = 0; var5 < var14; ++var5) {
         ...
         IsoSprite var7 = IsoSprite.getSprite(IsoSpriteManager.instance, var6);
         if (var7 != null) {
            IsoSpriteInstance var8 = var7.newInstance();
            ...
            if (var9) {
               ...
               var8.tintb = 1.0F;
               var8.alpha = 1.0F;
               var8.targetAlpha = 1.0F;
            } else {
               var8.offX = var1.getFloat();
               var8.offY = var1.getFloat();
               var8.offZ = var1.getFloat();
               var8.tintr = var1.getFloat();
               var8.tintg = var1.getFloat();
               var8.tintb = var1.getFloat();
            }

            var8.Flip = var1.get() != 0;
            byte var10 = var1.get();
            var8.bCopyTargetAlpha = (var10 & 1) != 0;
            var8.bMultiplyObjectAlpha = (var10 & 2) != 0;
            if (var8.bMultiplyObjectAlpha) {
               var8.alpha = var1.getFloat();
            }

            if (var7.name != null && var7.name.startsWith("overlay_blood_")) {
               float var11 = (float)GameTime.getInstance().getWorldAgeHours();
               IsoWallBloodSplat var12 = new IsoWallBloodSplat(var11, var7);
               if (this.wallBloodSplats == null) {
                  this.wallBloodSplats = new ArrayList();
               }

               this.wallBloodSplats.add(var12);
            } else {
               this.AttachedAnimSprite.add(var8);
            }
         } else {
            if (Core.bDebug) {
      ...
      for(int var19 = 0; var19 < var18; ++var19) {
         try {
            ItemContainer var23 = new ItemContainer();
            var23.ID = 0;
            var23.parent = this;
            var23.parent.square = this.square;
            var23.SourceGrid = this.square;
            var23.load(var1, var2);
            if (var19 == 0) {
               if (this instanceof IsoDeadBody) {
                  var23.Capacity = 8;
               }

               this.container = var23;
            } else {
               this.addSecondaryContainer(var23);
            }
      ...
      if (var2 >= 34 && var1.get() == 1) {
         ...
         if (!var20.isEmpty()) {
            this.overlaySprite = IsoSpriteManager.instance.getSprite(var20);
            this.overlaySprite.name = var20;
         }
      ...
      if (var2 >= 65) {
         ...
         if (var22 > 0) {
            ...
            if (GameClient.bClient || GameServer.bServer) {
               var24 = ServerOptions.getInstance().BloodSplatLifespanDays.getValue();
            }

            float var26 = (float)GameTime.getInstance().getWorldAgeHours();

            for(int var27 = 0; var27 < var22; ++var27) {
               IsoWallBloodSplat var28 = new IsoWallBloodSplat();
               var28.load(var1, var2);
               if (var28.worldAge > var26) {
                  var28.worldAge = var26;
               }

               if (var24 <= 0 || !(var26 - var28.worldAge >= (float)(var24 * 24))) {
                  this.wallBloodSplats.add(var28);
               }
            }
         }
      }
      ...
      if (this.Serialize()) {
         ...
         if (this.AttachedAnimSprite == null) {
            ...
            for(var3 = 0; var3 < var2; ++var3) {
               ...
               byte var5 = 0;
               if (var4.bCopyTargetAlpha) {
                  var5 = (byte)(var5 | 1);
               }

               if (var4.bMultiplyObjectAlpha) {
                  var5 = (byte)(var5 | 2);
               }

               var1.put(var5);
               if (var4.bMultiplyObjectAlpha) {
                  var1.putFloat(var4.alpha);
               }
            }
         }
         ...
         for(var2 = 0; var2 < this.getContainerCount(); ++var2) {
            this.getContainerByIndex(var2).save(var1);
         }
         ...
         if (this.wallBloodSplats == null) {
            ...
            for(int var6 = var3; var6 < this.wallBloodSplats.size(); ++var6) {
               ((IsoWallBloodSplat)this.wallBloodSplats.get(var6)).save(var1);
            }
         }
   ...
   public void Collision(Vector2 var1, IsoObject var2) {
      if (var2 instanceof BaseVehicle) {
         ...
         if (this.getProperties().Is("HitByCar")) {
            BaseVehicle var6 = (BaseVehicle)var2;
            String var7 = this.getSprite().getProperties().Val("MinimumCarSpeedDmg");
            if (var7 == null) {
               var7 = "150";
            }

            if (Math.abs(var6.getCurrentSpeedKmHour()) > (float)Integer.parseInt(var7)) {
               this.Damage(Math.abs(var6.getFudgedMass() * var6.getCurrentSpeedKmHour()) / 300.0F);
               if (this.Damage <= 0 && BrokenFences.getInstance().isBreakableObject(this)) {
                  IsoDirections var5;
                  if (this.getProperties().Is(IsoFlagType.collideN)) {
                     var5 = var6.getY() >= this.getY() ? IsoDirections.N : IsoDirections.S;
                  } else {
                     var5 = var6.getX() >= this.getX() ? IsoDirections.W : IsoDirections.E;
                  }
               ...
               var6.ApplyImpulse(this, Math.abs(var6.getFudgedMass() * var6.getCurrentSpeedKmHour() * 10.0F / 200.0F));
               if (var6.getCurrentSpeedKmHour() > 3.0F) {
                  var6.ApplyImpulse(this, Math.abs(var6.getFudgedMass() * var6.getCurrentSpeedKmHour() * 10.0F / 150.0F));
               }
   ...
   public boolean isAlphaAndTargetZero() {
      ...
      return this.alpha[var1] <= 0.001F && this.targetAlpha[var1] <= 0.001F;
   }
            ...
            for(int var3 = 0; var3 < 8; ++var3) {
               ...
               if (var4 != null) {
                  ...
                  for(int var6 = 0; var6 < var5.size(); ++var6) {
                     ...
                     if ((var7.getSprite() == null || !var7.getSprite().solidfloor) && !var7.getUsesExternalWaterSource() && var7.hasWater()) {
                        return var7;
                     }
                  }
               }
   ...
   public int getWaterMax() {
      if (this.sprite == null) {
         ...
         if (this.sprite.getProperties().Is(IsoFlagType.waterPiped) && GameTime.getInstance().getNightsSurvived() < SandboxOptions.instance.getWaterShutModifier() && this.square != null && this.square.getRoom() != null) {
            ...
            return this.externalWaterSource != null && this.externalWaterSource.hasWater() ? this.externalWaterSource.getWaterMax() : 0;
         }
      } else if (this.sprite.getProperties().Is(IsoFlagType.waterPiped) && GameTime.getInstance().getNightsSurvived() < SandboxOptions.instance.getWaterShutModifier()) {
         return this.hasModData() && this.getModData().rawget("canBeWaterPiped") instanceof Boolean && (Boolean)this.getModData().rawget("canBeWaterPiped") ? 0 : 10000;
      } else {
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      if (!this.isSpriteInvisible()) {
         ...
         if (this.shouldDrawMainSprite()) {
            ...
            if (this.isOutlineHighlight && !this.isOutlineHlAttached && IsoObject.OutlineShader.instance.StartShader()) {
               IsoObject.OutlineShader.instance.setOutlineColor(this.outlineHighlightCol.r, this.outlineHighlightCol.g, this.outlineHighlightCol.b, this.isOutlineHlBlink ? Core.blinkAlpha : 1.0F);
               var8 = this.sprite.getTextureForCurrentFrame(this.dir);
               if (var8 != null) {
                  IsoObject.OutlineShader.instance.setStepSize(this.outlineThickness, var8.getWidth(), var8.getHeight());
               }
   ...
   public void renderWallTile(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7, Consumer var8) {
      if (!this.isSpriteInvisible()) {
         ...
         if (this.isOutlineHighlight && !this.isOutlineHlAttached && IsoObject.OutlineShader.instance.StartShader()) {
            ...
            if (var9 != null) {
               IsoObject.OutlineShader.instance.setStepSize(this.outlineThickness, var9.getWidth(), var9.getHeight());
            }
   ...
   private void prepareToRender(ColorInfo var1) {
      ...
      if (this == IsoCamera.CamCharacter) {
         this.targetAlpha[var13] = 1.0F;
         this.alpha[var13] = 1.0F;
      }
         ...
         if (!var14 && ((float)this.square.getX() > var3 || (float)this.square.getY() > var4) && (int)var5 <= this.square.getZ()) {
            ...
            if (var16) {
               ...
               if (this.bAlphaForced) {
                  if (this.targetAlpha[var13] == 1.0F) {
                     this.targetAlpha[var13] = 0.99F;
                     this.alpha[var13] = 0.99F;
                  }
               } else {
                  this.targetAlpha[var13] = var8;
               }
      ...
      if (this instanceof IsoGameCharacter && !((IsoGameCharacter)this).SpottedSinceAlphaZero[var13]) {
         this.targetAlpha[var13] = 0.0F;
      }
      ...
      if (!this.bAlphaForced) {
         if (this.bNeverDoneAlpha) {
            this.alpha[var13] = this.targetAlpha[var13];
            this.bNeverDoneAlpha = false;
         }

         float[] var10000;
         if (this.alpha[var13] < this.targetAlpha[var13]) {
            var10000 = this.alpha;
            var10000[var13] += alphaStep * var15;
            if (this.alpha[var13] > this.targetAlpha[var13]) {
               this.alpha[var13] = this.targetAlpha[var13];
            }
         } else if (this.alpha[var13] > this.targetAlpha[var13]) {
            var10000 = this.alpha;
            var10000[var13] -= alphaStep / var17;
            if (this.alpha[var13] < this.targetAlpha[var13]) {
               this.alpha[var13] = this.targetAlpha[var13];
            }
         }

         if (this.alpha[var13] < 0.0F) {
            this.alpha[var13] = 0.0F;
         }

         if (this.alpha[var13] > 1.0F) {
            this.alpha[var13] = 1.0F;
         }
   ...
   public ColorInfo getOutlineHighlightCol() {
      return this.outlineHighlightCol;
   }

   public void setOutlineHighlightCol(ColorInfo var1) {
      this.outlineHighlightCol = var1;
   }

   public void setOutlineHighlightCol(float var1, float var2, float var3, float var4) {
      this.outlineHighlightCol.r = var1;
      this.outlineHighlightCol.g = var2;
      this.outlineHighlightCol.b = var3;
      this.outlineHighlightCol.a = var4;
   }

   public boolean isOutlineHighlight() {
      return this.isOutlineHighlight;
   }

   public void setOutlineHighlight(boolean var1) {
      this.isOutlineHighlight = var1;
   }

   public boolean isOutlineHlAttached() {
      return this.isOutlineHlAttached;
   }

   public void setOutlineHlAttached(boolean var1) {
      this.isOutlineHlAttached = var1;
   }

   public boolean isOutlineHlBlink() {
      return this.isOutlineHlBlink;
   }

   public void setOutlineHlBlink(boolean var1) {
      this.isOutlineHlBlink = var1;
   }
