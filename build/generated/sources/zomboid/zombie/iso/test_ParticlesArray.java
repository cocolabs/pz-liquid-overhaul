...
public class test_ParticlesArray extends Assert {
   ...
   public void test_ParticlesArray_time() {
      ...
      var2.sort(var12);
      var11 = System.currentTimeMillis();
      System.out.println("Sort " + var2.size() + " elements = " + (var11 - var3) + " ms (size=" + var2.size() + ", count=" + var2.getCount() + ")");
      var1 = 0;
      var3 = System.currentTimeMillis();
      ...
      var11 = System.currentTimeMillis();
      System.out.println("Defragment " + var2.size() + " elements = " + (var11 - var3) + " ms (size=" + var2.size() + ", count=" + var2.getCount() + ")");
      var3 = System.currentTimeMillis();
