...
public class ImprovedFog {
   ...
   private static float topAlphaHeight = 0.32F;
   private static float bottomAlphaHeight = 0.16F;
   ...
   public static void update() {
      ...
      if (!enableEditing) {
         ...
         if (highQuality) {
            renderEveryXRow = 1;
            topAlphaHeight = 0.48F;
            bottomAlphaHeight = 0.16F;
            octaves = 6.0F;
      ...
      if (baseAlpha <= 0.0F) {
         ...
         scalingX += var2 * 0.0035F * climateManager.getWindIntensity() * GameTime.getInstance().getMultiplier();
         scalingY += var3 * 0.0035F * climateManager.getWindIntensity() * GameTime.getInstance().getMultiplier();
      }
   ...
   private static void renderFogSegment() {
      ...
      float var10 = (var6 - var4) / (64.0F * (float)Core.TileScale);
      float var11 = (float)var3.startX % 6.0F;
      float var12 = var11 / 6.0F;
      float var13 = var10 / 6.0F;
      float var16 = var13 + var12;
      if (FogShader.instance.StartShader()) {
         FogShader.instance.setScreenInfo(screenWidth, screenHeight, ZOOM, secondLayerAlpha);
         ...
         FogShader.instance.setCameraInfo(cameraOffscreenLeft, cameraOffscreenTop, cameraZoom, 0.0F);
         SpriteRenderer.instance.render((Texture)null, (float)((int)var4), (float)((int)var5), (float)((int)(var6 - var4)), (float)((int)var8), 1.0F, 1.0F, 1.0F, var2, var12, 0.0F, var16, 0.0F, var16, 1.0F, var12, 1.0F);
         IndieGL.EndShader();
      }
