...
public class WeatherPeriod {
   ...
   private void createWeatherPattern() {
      ...
      this.print("WeatherPeriod: Duration = " + this.duration + ".");
      double var23 = this.startTime;

      for(int var22 = 0; var22 < this.weatherStages.size(); ++var22) {
         var23 = ((WeatherPeriod.WeatherStage)this.weatherStages.get(var22)).setStageStart(var23);
      }
