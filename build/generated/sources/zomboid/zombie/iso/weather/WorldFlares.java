...
public class WorldFlares {
   ...
   public static void debugRender() {
      if (DEBUG_DRAW) {
         ...
         for(int var3 = flares.size() - 1; var3 >= 0; --var3) {
            WorldFlares.Flare var4 = (WorldFlares.Flare)flares.get(var3);
            float var5 = 0.5F;

            for(double var6 = 0.0D; var6 < 6.283185307179586D; var6 += 0.15707963267948966D) {
               DrawIsoLine(var4.x + (float)var4.range * (float)Math.cos(var6), var4.y + (float)var4.range * (float)Math.sin(var6), var4.x + (float)var4.range * (float)Math.cos(var6 + 0.15707963267948966D), var4.y + (float)var4.range * (float)Math.sin(var6 + 0.15707963267948966D), var2, 1.0F, 1.0F, 1.0F, 0.25F, 1);
               DrawIsoLine(var4.x + var5 * (float)Math.cos(var6), var4.y + var5 * (float)Math.sin(var6), var4.x + var5 * (float)Math.cos(var6 + 0.15707963267948966D), var4.y + var5 * (float)Math.sin(var6 + 0.15707963267948966D), var2, 1.0F, 1.0F, 1.0F, 0.25F, 1);
            }
         }
   ...
   public static class Flare {
      ...
      private void applyFlare(RenderSettings.PlayerRenderSettings var1, int var2, IsoPlayer var3) {
         ...
         if (var4.distMod > 0.0F) {
            ...
            var4.outColor.getExterior().g *= 1.0F - var5 * var6 * var4.intensity * 0.5F;
            var4.outColor.getInterior().g *= 1.0F - var5 * var6 * var4.intensity * 0.5F;
            var4.outColor.getExterior().b *= 1.0F - var5 * var6 * var4.intensity * 0.8F;
            var4.outColor.getInterior().b *= 1.0F - var5 * var6 * var4.intensity * 0.8F;
   ...
   private static class PlayerFlareLightInfo {
      ...
      // $FF: synthetic method
      PlayerFlareLightInfo(Object var1) {
         this();
      }
   }
}
