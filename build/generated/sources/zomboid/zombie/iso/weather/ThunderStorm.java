               ...
               if (var21.soundDelay.finished()) {
                  ...
                  if (var8 && !Core.SoundDisabled && FMODManager.instance.getNumListeners() > 0) {
                     ...
                     if (var21.doStrike && (!var15 || !var17)) {
                        ...
                        if (var10 != null && var10.event != null && !var10.event.isEmpty()) {
                           var11 = javafmod.FMOD_Studio_System_GetEvent("event:/" + var10.event);
                           ...
                           javafmod.FMOD_Studio_SetVolume(var13, var10.getEffectiveVolume());
