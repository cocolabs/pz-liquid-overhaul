...
public class WeatherFxMask {
   ...
   private static boolean isInPlayerBuilding(IsoGridSquare var0, int var1x, int var2x, int var3x) {
      ...
      if (var0 != null && var0.Is(IsoFlagType.solidfloor)) {
         ...
         if (var0.getBuilding() == null) {
            return var4.curMasterRegion != null && var0.getMasterRegion() != null && var0.getMasterRegion().isFogMask() && (var0.getMasterRegion() == var4.curMasterRegion || var4.curConnectedRegions.contains(var0.getMasterRegion()));
         }
      } else {
         ...
         if (var0 == null && var4.curMasterRegion != null) {
            MasterRegion var5 = IsoRegion.getMasterRegion(var1x, var2x, var3x);
            return var5 != null && var5.isFogMask() && (var5 == var4.curMasterRegion || var4.curConnectedRegions.contains(var5));
         }
      }
   ...
   public static class PlayerFxMask {
      ...
      private int playerZ;
      private MasterRegion curMasterRegion;
      private ArrayList curConnectedRegions = new ArrayList();
      private final ArrayList masterRegionTemp = new ArrayList();
      ...
      private void initMask() {
         if (!GameServer.bServer) {
            ...
            if (this.player != null) {
               ...
               this.curMasterRegion = this.player.getMasterRegion();
               this.curConnectedRegions.clear();
               if (this.curMasterRegion != null && this.player.getMasterRegion().isFogMask()) {
                  this.masterRegionTemp.clear();
                  this.masterRegionTemp.add(this.curMasterRegion);

                  label79:
                  while(true) {
                     MasterRegion var1;
                     do {
                        if (this.masterRegionTemp.size() <= 0) {
                           break label79;
                        }

                        var1 = (MasterRegion)this.masterRegionTemp.remove(0);
                     ...
                     while(var2.hasNext()) {
                        ...
                        if (!this.masterRegionTemp.contains(var3) && !this.curConnectedRegions.contains(var3) && var3.isFogMask()) {
                           this.masterRegionTemp.add(var3);
                        }
                     }
                  }
               } else {
                  this.curMasterRegion = null;
               }
            }
            ...
            if (IsoWeatherFX.instance == null) {
               ...
               if (this.hasMaskToDraw) {
                  if ((this.player.getSquare() == null || this.player.getSquare().getBuilding() == null && this.player.getSquare().Is(IsoFlagType.exterior)) && (this.curMasterRegion == null || !this.curMasterRegion.isFogMask())) {
                     this.hasMaskToDraw = false;
                  } else {
                     this.hasMaskToDraw = true;
                  }
