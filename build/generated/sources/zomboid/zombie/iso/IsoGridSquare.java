...
public final class IsoGridSquare {
   ...
   public final boolean[][][] collideMatrix = new boolean[3][3][3];
   public final boolean[][][] pathMatrix = new boolean[3][3][3];
   public final boolean[][][] visionMatrix = new boolean[3][3][3];
   ...
   private static final int cutawayLogWallWOffset = -22;
   private static final int cutawaySpiffoWindowWXOffset = -24;
   private static final int cutawayRedGarageDoor = -64;
      ...
      if (var11 != null && var11.getID() != -1) {
         ...
         try {
            ...
            if (var1.sprite.name.contains("fencing_01_11")) {
               ...
               var15 = -24.0F;
               var17 = -24;
            } else if (var1.sprite.name.contains("garage_02_34")) {
               var17 = -64;
            }

            IsoGridSquare.CircleStencilShader var19 = IsoGridSquare.CircleStencilShader.instance;
            short var20;
            short var21;
            short var22;
            int var23;
            if (var2 == IsoDirections.N || var2 == IsoDirections.NW) {
               ...
               if (var1.sprite.getProperties().Is(IsoFlagType.WallSE)) {
                  ...
                  SpriteRenderer.instance.setCutawayTexture(var11, var20 + (int)var15, var22 + (int)var16, 66 - var17, 226 - var18);
               }
               ...
               var10.col[2] = coll;
               var10.col[3] = colu;
               var1.renderWallTileOnly((float)this.x, (float)this.y, (float)this.z, var12 ? var14 : defColorInfo, var19, var10);
            }
      ...
      if (var9 != null && var9.getID() != -1) {
         try {
            ...
            if (var1.name.contains("fencing_01_11")) {
               ...
               var11 = -24.0F;
               var13 = -24;
            } else if (var1.name.contains("garage_02_34")) {
               var13 = -64;
            }
            ...
            if (var2 == IsoDirections.N || var2 == IsoDirections.NW) {
               ...
               if (var1.getProperties().Is(IsoFlagType.WallSE)) {
                  SpriteRenderer.instance.setCutawayTexture(var9, var16 + (int)var11, 0 + (int)var12, 6 - var13, 196 - var14);
               } else {
                  SpriteRenderer.instance.setCutawayTexture(var9, var15 + (int)var11, 0 + (int)var12, 66 - var13, 226 - var14);
               }
   ...
   public int DoWallLightingN(IsoObject var1, int var2, boolean var3, boolean var4, boolean var5, boolean var6, Shader var7) {
      if (!DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Walls.N.getValue()) {
         ...
         WallShaperWhole var22 = WallShaperWhole.instance;
         var22.col[0] = colu2;
         var22.col[1] = coll2;
         var22.col[2] = coll;
         var22.col[3] = colu;
         return this.performDrawWallSegmentSingle(var1, var2, false, var3, false, false, var4, var5, var6, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var22, var7);
      }
   }
   ...
   public int DoWallLightingW(IsoObject var1, int var2, boolean var3, boolean var4, boolean var5, boolean var6, Shader var7) {
      if (!DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Walls.W.getValue()) {
         ...
         boolean var15 = var3 || var4;
         IsoFlagType var16 = IsoFlagType.transparentW;
         IsoFlagType var17 = IsoFlagType.WindowW;
         IsoFlagType var18 = IsoFlagType.HoppableW;
         IsoDirections var19 = IsoDirections.W;
         boolean var20 = CircleStencil;
         int var21 = IsoCamera.frameState.playerIndex;
         colu = this.getVertLight(0, var21);
         coll = this.getVertLight(3, var21);
         colu2 = this.getVertLight(4, var21);
         coll2 = this.getVertLight(7, var21);
         if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Walls.LightingDebug.getValue()) {
            colu = -65536;
            coll = -16711936;
            colu2 = -16776961;
         ...
         var22.col[2] = colu;
         var22.col[3] = coll;
         return this.performDrawWallSegmentSingle(var1, var2, var3, var4, var5, var6, false, false, false, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var22, var7);
      }
   }
   ...
   private void calculateWallAlphaCommon(IsoObject var1, boolean var2, boolean var3, boolean var4, int var5, boolean var6, boolean var7) {
      if (var6 || var7) {
         if (var2) {
            var1.alpha[var5] = 0.4F;
            var1.targetAlpha[var5] = 0.4F;
            ...
            if (var6 && !var3) {
               var1.alpha[var5] = 0.0F;
               var1.targetAlpha[var5] = 0.0F;
            }
   ...
   public IsoTree getTree() {
      for(int var1 = 0; var1 < this.Objects.size(); ++var1) {
         IsoTree var2 = (IsoTree)Type.tryCastTo(this.Objects.get(var1), IsoTree.class);
         if (var2 != null) {
            return var2;
         }
      }
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      for(var4 = 0; var4 < var15; ++var4) {
         ...
         if (var9 == null) {
            if (DEBUG_SAVE) {
               var23 = var1.position();
               if (var23 - var5 != var6) {
                  DebugLog.log("***** Object loaded size " + (var23 - var5) + " != saved size " + var6);
               }
            }
         } else {
            var9.square = this;
      ...
      if (DEBUG_SAVE) {
         ...
         byte var21 = var1.get();
         byte var20 = var1.get();
         if (var16 != 67 || var18 != 82 || var21 != 80 || var20 != 83) {
            DebugLog.log("***** Expected CRPS here");
         }
      }

      if (GameWindow.DEBUG_SAVE) {
         String var17 = GameWindow.ReadStringUTF(var1);
         DebugLog.log(var17);
      }
      ...
      for(var4 = 0; var4 < var15; ++var4) {
         ...
         try {
            var19 = (IsoMovingObject)IsoObject.factoryFromFileInput(this.getCell(), var1);
         ...
         if (var19 != null) {
            ...
            this.StaticMovingObjects.add(var19);
      ...
      if (var2 >= 34) {
         if (var2 < 39) {
            ...
            var16 = var1.get();
            this.setOverlayDone((var16 & 1) != 0);
            this.haveRoof = (var16 & 2) != 0;
            this.burntOut = (var16 & 4) != 0;
         }
      }
   ...
   private IsoObject getSpecialWall(boolean var1) {
      for(int var2 = this.SpecialObjects.size() - 1; var2 >= 0; --var2) {
         ...
         if (var3 instanceof IsoThumpable) {
            IsoThumpable var4 = (IsoThumpable)var3;
            if (var4.isStairs() || !var4.isThumpable() && !var4.isWindow() && !var4.isDoor() || var4.isCanPassThrough() || var4.isDoor() && var4.open || var4.isBlockAllTheSquare()) {
               continue;
            }
   ...
   public IsoThumpable AddStairs(boolean var1, int var2, String var3, String var4, KahluaTable var5) {
      ...
      this.SpecialObjects.add(var7);
      this.Properties.Clear();

      int var8;
      for(var8 = 0; var8 < this.Objects.size(); ++var8) {
         IsoObject var9 = (IsoObject)this.Objects.get(var8);
         if (var9.sprite != null) {
            this.Properties.AddProperties(var9.sprite.getProperties());
         }
      }

      if (var6 && var2 == 2) {
         var8 = this.z - 1;
         IsoGridSquare var12 = this.getCell().getGridSquare(this.x, this.y, var8);
         if (var12 == null) {
            var12 = new IsoGridSquare(this.getCell(), (SliceY)null, this.x, this.y, var8);
            this.getCell().ConnectNewSquare(var12, true);
         }

         while(var8 >= 0) {
            IsoThumpable var10 = new IsoThumpable(this.getCell(), var12, var4, var1, var5);
            var10.sprite.getProperties().Set(IsoFlagType.solidtrans);
            var10.sprite.getProperties().Set(var1 ? IsoFlagType.cutN : IsoFlagType.cutW);
            var12.Objects.add(var10);
            var12.SpecialObjects.add(var10);
            ...
            --var8;
            if (this.getCell().getGridSquare(var12.x, var12.y, var8) == null) {
               var12 = new IsoGridSquare(this.getCell(), (SliceY)null, var12.x, var12.y, var8);
               this.getCell().ConnectNewSquare(var12, true);
            } else {
               var12 = this.getCell().getGridSquare(var12.x, var12.y, var8);
            }
         }
      }
      ...
      if (var2 == 2) {
         ...
         if (var1) {
            if (IsoWorld.instance.isValidSquare(this.x, this.y - 1, this.z + 1)) {
               var13 = this.getCell().getGridSquare(this.x, this.y - 1, this.z + 1);
               if (var13 == null) {
                  var13 = new IsoGridSquare(this.getCell(), (SliceY)null, this.x, this.y - 1, this.z + 1);
                  this.getCell().ConnectNewSquare(var13, false);
               }

               if (!var13.Properties.Is(IsoFlagType.solidfloor)) {
                  var13.addFloor("carpentry_02_57");
               }
            }
         } else if (IsoWorld.instance.isValidSquare(this.x - 1, this.y, this.z + 1)) {
            var13 = this.getCell().getGridSquare(this.x - 1, this.y, this.z + 1);
            if (var13 == null) {
               var13 = new IsoGridSquare(this.getCell(), (SliceY)null, this.x - 1, this.y, this.z + 1);
               this.getCell().ConnectNewSquare(var13, false);
            }
         ...
         var13.getModData().rawset("ConnectedToStairs" + var1, true);
         var13 = this.getCell().getGridSquare(this.x, this.y, this.z + 1);
         if (var13 == null) {
            var13 = new IsoGridSquare(this.getCell(), (SliceY)null, this.x, this.y, this.z + 1);
            this.getCell().ConnectNewSquare(var13, false);
         }
      }

      for(var8 = this.getX() - 1; var8 <= this.getX() + 1; ++var8) {
         for(int var15 = this.getY() - 1; var15 <= this.getY() + 1; ++var15) {
            for(int var14 = this.getZ() - 1; var14 <= this.getZ() + 1; ++var14) {
               if (IsoWorld.instance.isValidSquare(var8, var15, var14)) {
                  IsoGridSquare var11 = this.getCell().getGridSquare(var8, var15, var14);
                  if (var11 == null) {
                     var11 = new IsoGridSquare(this.getCell(), (SliceY)null, var8, var15, var14);
                              ...
                              if (var13.getProperties().Is(IsoFlagType.WindowW)) {
                                 ...
                                 if (var13.getContainer() != null && var13.getContainer().getItems() != null) {
                                    ...
                                    if (var13.getSprite().getName().startsWith("walls_exterior_roofs_")) {
                                       var13.sprite = IsoSpriteManager.instance.getSprite("walls_burnt_roofs_01_" + var13.getSprite().getName().substring(var13.getSprite().getName().lastIndexOf("_") + 1, var13.getSprite().getName().length()));
                                    } else if (var13.getSprite().getName().startsWith("roofs_")) {
                                       var13.sprite = IsoSpriteManager.instance.getSprite("roofs_burnt_01_" + var13.getSprite().getName().substring(var13.getSprite().getName().lastIndexOf("_") + 1, var13.getSprite().getName().length()));
            ...
            if (var8 != null && var8.sprite != null) {
               ...
               if ((!var2 || var9) && (var2 || !var9)) {
                  ...
                  if (GameClient.bClient && var8 != IsoPlayer.getInstance() && !(var8 instanceof IsoLuaMover)) {
                     var8.render(var8.bx, var8.by, var8.getZ(), var5, true, false, (Shader)null);
                  } else {
                     var8.render(var8.getX(), var8.getY(), var8.getZ(), var5, true, false, (Shader)null);
                  }
               }
         ...
         if (this.DeferredCharacterTick != this.getCell().DeferredCharacterTick) {
            ...
            for(int var6 = 0; var6 < this.DeferedCharacters.size(); ++var6) {
               ...
               if (var7.sprite != null) {
                  ...
                  if (GameClient.bClient && var7 != IsoPlayer.getInstance() && !(var7 instanceof IsoLuaMover)) {
                     var7.render(var7.bx, var7.by, var7.getZ(), var5, true, false, (Shader)null);
                  } else {
   ...
   private int renderFloorInternal(Shader var1) {
      ...
      for(var21 = 0; var21 < var19; ++var21) {
         ...
         if (!var23) {
            ...
            IndieGL.glAlphaFunc(516, 0.0F);
            var22.targetAlpha[var2] = var11;
            if (var9) {
               var22.alpha[var2] = var10;
            }
         ...
         while(true) {
            ...
            if ((!var3 || var33 && this.bFlattenGrassEtc) && (var3 || !var33 || !this.bFlattenGrassEtc)) {
               ...
               if (var31) {
                  ...
                  if (var36) {
                     var47.targetAlpha[var9] = 0.6F;
                     var47.alpha[var9] = 0.6F;
                  }
                  ...
                  if (var47.sprite == null || !var34 && !var35) {
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Objects.getValue()) {
                        if (this.getRoomID() != -1 || !var6 && !var4 || var32 != IsoObjectType.WestRoofB && var32 != IsoObjectType.WestRoofM && var32 != IsoObjectType.WestRoofT) {
                           if (var10 != null && this.getRoomID() != -1 && var28 == -1 && var14) {
                              var47.targetAlpha[var9] = 0.0F;
                           } else if (var10 != null && !var12 && this.getRoomID() != var28 && var13 < 0.5F) {
                              var47.targetAlpha[var9] = var13 * 2.0F;
                           } else {
                              if (!var36) {
                                 var47.targetAlpha[var9] = 1.0F;
                              }
                        ...
                        if (var47 instanceof IsoTree) {
                           if (var17 && this.x >= (int)IsoCamera.frameState.CamCharacterX && this.y >= (int)IsoCamera.frameState.CamCharacterY && var10 != null && var10.Is(IsoFlagType.exterior)) {
                              ...
                              var47.targetAlpha[var9] = Math.min(0.99F, var47.targetAlpha[var9]);
                           } else {
                     ...
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.DoorsAndWalls.getValue()) {
                        CircleStencil = true;
                        if (var10 != null && this.getRoomID() != -1 && var28 == -1 && var14) {
                           var47.targetAlpha[var9] = 0.5F;
                           var47.alpha[var9] = 0.5F;
                        } else if (!var36) {
                           var47.targetAlpha[var9] = 1.0F;
                           var47.alpha[var9] = 1.0F;
                        }
                        ...
                        if (var47 instanceof IsoWindow && var47.targetAlpha[var9] < 1.0F) {
                     ...
                     if (var47.targetAlpha[var9] < 1.0F) {
                        var47.targetAlpha[var9] = var17 ? var47.targetAlpha[var9] : 1.0F;
                        var47.alpha[var9] = var47.targetAlpha[var9];
   ...
   public void drawCircleExplosion(int var1, IsoTrap var2, boolean var3) {
      ...
      if (var2.getExplosionSound() != null && !var3) {
         ...
         WorldSoundManager.instance.addSound((Object)null, this.x, this.y, 0, 50, 1);
      }

      if (var2.getNoiseRange() > 0 && !var3) {
         WorldSoundManager.instance.addSound((Object)null, this.x, this.y, 0, var2.getNoiseRange(), 1);
      }
   ...
   public boolean getCollideMatrix(int var1, int var2, int var3) {
      return this.collideMatrix[var1 + 1][var2 + 1][var3 + 1];
   }

   public boolean getPathMatrix(int var1, int var2, int var3) {
      return this.pathMatrix[var1 + 1][var2 + 1][var3 + 1];
   }

   public boolean getVisionMatrix(int var1, int var2, int var3) {
      return this.visionMatrix[var1 + 1][var2 + 1][var3 + 1];
   }

   static {
      isoGridSquareSet.setAutoCompactionFactor(0.0F);
      ...
      cellGetSquare = new IsoGridSquare.CellGetSquare();
