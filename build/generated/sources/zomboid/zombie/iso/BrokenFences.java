...
public class BrokenFences {
   ...
   public static final BrokenFences getInstance() {
      return instance;
   }
      ...
      while(var2.advance()) {
         ...
         if (!"VERSION".equalsIgnoreCase(var3)) {
            ...
            PZArrayUtil.forEach((List)var5.left, (var2x) -> {
               BrokenFences.Tile var10000 = (BrokenFences.Tile)this.s_brokenLeftMap.put(var2x, var5);
            });
            PZArrayUtil.forEach((List)var5.right, (var2x) -> {
               BrokenFences.Tile var10000 = (BrokenFences.Tile)this.s_brokenRightMap.put(var2x, var5);
            });
         }
      }
   ...
   public void updateSprite(IsoObject var1, boolean var2, boolean var3) {
      if (this.isBreakableObject(var1)) {
         ...
         if (var5 != null) {
            ...
            IsoRegion.squareChanged(var1.getSquare());
         }
