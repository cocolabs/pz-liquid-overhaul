...
public final class IsoObjectPicker {
   ...
   public IsoObjectPicker.ClickObject ContextPick(int var1, int var2) {
      ...
      for(var5 = this.ThisFrame.size() - 1; var5 >= 0; --var5) {
         ...
         if ((!(var6.tile instanceof IsoPlayer) || var6.tile != IsoPlayer.players[0]) && (var6.tile.sprite == null || var6.tile.targetAlpha[0] != 0.0F && (!var6.tile.sprite.Properties.Is(IsoFlagType.cutW) && !var6.tile.sprite.Properties.Is(IsoFlagType.cutN) || !(var6.tile.targetAlpha[0] < 1.0F)))) {
   ...
   public IsoMovingObject PickTarget(int var1, int var2) {
      ...
      for(int var13 = this.ThisFrame.size() - 1; var13 >= 0; --var13) {
         ...
         if (var14.tile != IsoPlayer.getInstance() && (var14.tile.sprite == null || var14.tile.targetAlpha[IsoPlayer.getPlayerIndex()] != 0.0F)) {
            if (var14.tile != null && var14.tile.sprite != null) {
            }
         ...
         if (!(var6 instanceof IsoDoor) && (!(var6 instanceof IsoThumpable) || !((IsoThumpable)var6).isDoor())) {
            if (var6 instanceof IsoWindow) {
               ...
               if (var6 instanceof IsoPlayer) {
                  var1 -= 100000.0F;
               } else if (var6 instanceof IsoThumpable && var6.targetAlpha[IsoPlayer.getPlayerIndex()] < 0.99F && (var6.targetAlpha[IsoPlayer.getPlayerIndex()] < 0.5F || var6.getContainer() == null)) {
                  var1 -= 100000.0F;
               }
