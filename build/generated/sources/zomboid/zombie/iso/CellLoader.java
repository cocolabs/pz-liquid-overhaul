         ...
         if (var1 != IsoObjectType.doorW && var1 != IsoObjectType.doorN) {
            ...
            if (var1 == IsoObjectType.lightswitch) {
               ...
               if (((IsoObject)var8).sprite.getProperties().Is("lightR")) {
                  float var24 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightR")) / 255.0F;
                  float var21 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightG")) / 255.0F;
                  var11 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightB")) / 255.0F;
                  int var22 = 10;
                  if (((IsoObject)var8).sprite.getProperties().Is("LightRadius") && Integer.parseInt(((IsoObject)var8).sprite.getProperties().Val("LightRadius")) > 0) {
                     var22 = Integer.parseInt(((IsoObject)var8).sprite.getProperties().Val("LightRadius"));
                  }

                  IsoLightSource var23 = new IsoLightSource(((IsoObject)var8).square.getX(), ((IsoObject)var8).square.getY(), ((IsoObject)var8).square.getZ(), var24, var21, var11, var22);
                  var23.bActive = true;
                  var23.bHydroPowered = true;
                  var23.switches.add((IsoLightSwitch)var8);
                  ((IsoLightSwitch)var8).lights.add(var23);
               } else {
               ...
               if (!var0.getProperties().Is(IsoFlagType.windowW) && !var0.getProperties().Is(IsoFlagType.windowN)) {
                  if (var0.getProperties().Is(IsoFlagType.container) && var0.getProperties().Val("container").equals("barbecue")) {
                     ...
                     if (var0.getProperties().Is("signal")) {
                        var15 = var0.getProperties().Val("signal");
                        if ("radio".equals(var15)) {
                           var8 = new IsoRadio(var3, var2, var0);
                        } else if ("tv".equals(var15)) {
                        ...
                        if (var0.getProperties().Is(IsoFlagType.WallOverlay)) {
                           ...
                           if (var0.getProperties().Is(IsoFlagType.attachedSE)) {
                              var16 = var2.getWallSE();
                           } else if (var0.getProperties().Is(IsoFlagType.attachedW)) {
                              var16 = var2.getWall(false);
                           } else if (var0.getProperties().Is(IsoFlagType.attachedN)) {
                              var16 = var2.getWall(true);
                           } else {
                              for(int var19 = var2.getObjects().size() - 1; var19 >= 0; --var19) {
                                 IsoObject var20 = (IsoObject)var2.getObjects().get(var19);
                                 if (var20.sprite.getProperties().Is(IsoFlagType.cutW) || var20.sprite.getProperties().Is(IsoFlagType.cutN)) {
                                    var16 = var20;
                                    break;
                                 }
                              }
                           ...
                           if (var16 != null) {
                              if (var16.AttachedAnimSprite == null) {
                                 var16.AttachedAnimSprite = new ArrayList(4);
                              }

                              var16.AttachedAnimSprite.add(IsoSpriteInstance.get(var0));
                           } else {
                        ...
                        if (var0.getProperties().Is(IsoFlagType.FloorOverlay)) {
                           ...
                           if (var0.getName() != null && var0.getName().startsWith("vegetation_trees")) {
                              var16 = var2.getFloor();
                              if (var16 == null || var16.getSprite() == null || var16.getSprite().getName() == null || !var16.getSprite().getName().startsWith("blends_natural")) {
                           ...
                           for(var9 = 0; var9 < var2.getObjects().size(); ++var9) {
                              IsoObject var18 = (IsoObject)var2.getObjects().get(var9);
                              if (var18 instanceof IsoTree) {
                                 var2.getObjects().remove(var9);
                                 var18.reset();
                                 isoTreeCache.push((IsoTree)var18);
                                 break;
                              }
                           }
                           ...
                           var15 = GameServer.bServer ? null : ((IsoDirectionFrame)var0.CurrentAnim.Frames.get(0)).getTexture(IsoDirections.N).getName();
                           boolean var10 = true;
                           if (!GameServer.bServer && var15.contains("TileObjectsExt") && (var15.contains("_5") || var15.contains("_6") || var15.contains("_7") || var15.contains("_8"))) {
                              var8 = new IsoWheelieBin(var3, var4, var5, var6);
                              if (var15.contains("_5")) {
                                 ((IsoObject)var8).dir = IsoDirections.S;
                              }

                              if (var15.contains("_6")) {
                                 ((IsoObject)var8).dir = IsoDirections.W;
                              }

                              if (var15.contains("_7")) {
                                 ((IsoObject)var8).dir = IsoDirections.N;
                              }

                              if (var15.contains("_8")) {
                           ...
                           if (var10) {
                              ...
                              AddObject(var2, (IsoObject)var8);
                              if (((IsoObject)var8).sprite.getProperties().Is("lightR")) {
                                 var11 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightR"));
                                 float var12 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightG"));
                                 float var13 = Float.parseFloat(((IsoObject)var8).sprite.getProperties().Val("lightB"));
                                 var3.getLamppostPositions().add(new IsoLightSource(((IsoObject)var8).square.getX(), ((IsoObject)var8).square.getY(), ((IsoObject)var8).square.getZ(), var11, var12, var13, 8));
                              }
                           }
                        }
                     }
               ...
               boolean var14 = Integer.parseInt(var7.substring(var7.lastIndexOf("_") + 1)) % 8 <= 3;
               var8 = new IsoCurtain(var3, var2, var0, var1 == IsoObjectType.curtainN || var1 == IsoObjectType.curtainS, var14);
               AddSpecialObject(var2, (IsoObject)var8);
               GameClient.instance.objectSyncReq.putRequest(var2, (IsoObject)var8);
            }
         } else {
            ...
            if (var0.getProperties().Is("GarageDoor")) {
               var9 = IsoDoor.getGarageDoorIndex((IsoObject)var8);
               if (var9 > 3) {
