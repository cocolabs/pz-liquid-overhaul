...
public final class IsoDeadBody extends IsoMovingObject implements Talker, IHumanVisual {
   ...
   public IsoDeadBody(IsoGameCharacter var1, boolean var2) {
      ...
      if (var4 != null) {
         if (GameClient.bClient && !var2 && var3 != null && !GameClient.instance.RecentlyDied.contains(var3.OnlineID)) {
            GameClient.instance.RecentlyDied.add(var3.OnlineID);
         }
                  ...
                  if (var9 != null) {
                     for(int var10 = 0; var10 < var9.getMovingObjects().size(); ++var10) {
                        if (var9.getMovingObjects().get(var10) instanceof IsoZombie) {
                           var11.add(var9.getMovingObjects().get(var10));
                        }
                     }
                  }
               }
   ...
   public void setAttachedItems(AttachedItems var1) {
      ...
      for(int var2 = 0; var2 < this.attachedItems.size(); ++var2) {
         ...
         if (!this.container.contains(var4)) {
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if (var1.get() == 1) {
         ...
         try {
            ...
            this.container.ID = var12;
            ArrayList var5 = this.container.load(var1, var2);
            byte var6 = var1.get();
            ...
            for(int var14 = 0; var14 < var13; ++var14) {
               ...
               if (var10 >= 0 && var10 < var5.size() && this.attachedItems.getGroup().getLocation(var15) != null) {
                  this.attachedItems.setItem(var15, (InventoryItem)var5.get(var10));
               }
            }
   ...
   public void save(ByteBuffer var1) throws IOException {
      ...
      if (this.container != null) {
         ...
         ArrayList var2 = this.container.save(var1);
         ...
         this.wornItems.forEach((var2x) -> {
            ...
            var1.putShort((short)var2.indexOf(var2x.getItem()));
         });
   ...
   public void renderShadow() {
      ...
      renderShadow(this.x, this.y, this.z, var1, var2, var3, var4, var6, this.alpha[var5]);
   }
   ...
   public void reanimate() {
      ...
      var3.setAlpha(1.0F);
      var3.setTargetAlpha(1.0F);
      Arrays.fill(var3.SpottedSinceAlphaZero, true);
      Arrays.fill(var3.timeTillForgetLocation, 600);
      ...
      if (this.isFakeDead() && SoundManager.instance.isListenerInRange(this.x, this.y, 20.0F) && !GameServer.bServer) {
         String var8 = var3.isFemale() ? "FemaleZombieReanimate" : "MaleZombieReanimate";
         var3.vocalEvent = var3.getEmitter().playVocals(var8);
      }
