...
public class IsoWindow extends IsoObject implements BarricadeAble, Thumpable {
   ...
   public void WeaponHit(IsoGameCharacter var1, HandWeapon var2) {
      if (GameClient.bClient) {
         ...
         if (var3 != null) {
            ...
            } else if (var2 != ((IsoPlayer)var1).bareHands) {
               if (var2 != null) {
      ...
      if (var2 >= 64) {
         ...
         if (this.closedSprite != null) {
            if (this.destroyed && this.closedSprite.getProperties().Is("SmashedTileOffset")) {
               ...
               this.closedSprite = IsoSprite.getSprite(IsoSpriteManager.instance, this.closedSprite, -var3);
            }

            if (this.closedSprite.getProperties().Is("GlassRemovedOffset")) {
               var3 = Integer.parseInt(this.closedSprite.getProperties().Val("GlassRemovedOffset"));
               this.glassRemovedSprite = IsoSprite.getSprite(IsoSpriteManager.instance, this.closedSprite, var3);
            }
         }
   ...
   public static boolean canClimbThroughHelper(IsoGameCharacter var0, IsoGridSquare var1, IsoGridSquare var2, boolean var3) {
      ...
      if (var4 == null) {
         ...
         return false;
      } else if (!var0.canClimbDownSheetRope(var4) && !var4.HasStairsBelow() && !PolygonalMap2.instance.canStandAt((float)var4.x + var5, (float)var4.y + var6, var4.z, (IsoMovingObject)null, true, true)) {
   ...
   public IsoGameCharacter getFirstCharacterClimbingThrough(IsoGridSquare var1) {
      if (var1 == null) {
         ...
         for(int var2 = 0; var2 < var1.getMovingObjects().size(); ++var2) {
            IsoGameCharacter var3 = (IsoGameCharacter)Type.tryCastTo(var1.getMovingObjects().get(var2), IsoGameCharacter.class);
