...
public class IsoMannequin extends IsoObject implements IHumanVisual {
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if (var1.get() == 1) {
         try {
            ...
            ArrayList var3 = this.container.load(var1, var2);
            byte var4 = var1.get();

            for(int var5 = 0; var5 < var4; ++var5) {
               String var6 = GameWindow.ReadString(var1);
               short var7 = var1.getShort();
               if (var7 >= 0 && var7 < var3.size() && this.wornItems.getBodyLocationGroup().getLocation(var6) != null) {
                  this.wornItems.setItem(var6, (InventoryItem)var3.get(var7));
               }
            }
   ...
   public void save(ByteBuffer var1) throws IOException {
      ItemContainer var2 = this.container;
      this.container = null;
      super.save(var1);
      this.container = var2;
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (this.bAnimate) {
         ...
         if (var10.atlasTex != null) {
            ...
            var11.render((float)((int)this.screenX - var11.getWidth() / 2), (float)((int)this.screenY - var11.getHeight() / 2), (float)var11.getWidth(), (float)var11.getHeight(), var4.r, var4.g, var4.b, this.alpha[var8], (Consumer)null);
            if (Core.bDebug) {
            }
         }
   ...
   private void updateAlpha() {
      ...
      if (this.bNeverDoneAlpha) {
         this.alpha[var1] = this.targetAlpha[var1];
         this.bNeverDoneAlpha = false;
      }

      float[] var10000;
      if (this.alpha[var1] < this.targetAlpha[var1]) {
         var10000 = this.alpha;
         var10000[var1] += alphaStep * var2;
         if (this.alpha[var1] > this.targetAlpha[var1]) {
            this.alpha[var1] = this.targetAlpha[var1];
         }
      } else if (this.alpha[var1] > this.targetAlpha[var1]) {
         var10000 = this.alpha;
         var10000[var1] -= alphaStep / var3;
         if (this.alpha[var1] < this.targetAlpha[var1]) {
            this.alpha[var1] = this.targetAlpha[var1];
         }
      }

      if (this.alpha[var1] < 0.0F) {
         this.alpha[var1] = 0.0F;
      }

      if (this.alpha[var1] > 1.0F) {
   ...
   private void renderShadow(float var1, float var2, float var3) {
      ...
      float var6 = 0.8F * this.alpha[var5];
   ...
   private void initOutfit() {
      if (!this.bInit) {
         ...
         this.humanVisual.setSkinTextureName((this.bFemale ? "F_Mannequin_" : "M_Mannequin_") + var1);
   ...
   private static final class StaticPerPlayer {
      ...
      void renderMoveableItem(Moveable var1, int var2, int var3, int var4, IsoDirections var5) {
         String var6 = var1.getWorldSprite();
         IsoSprite var7 = IsoSpriteManager.instance.getSprite(var6);
         if (var7 != null && IsoMannequin.isMannequinSprite(var7)) {
            if (var1.getByteData() != null) {
               ...
               if (this._mannequin.square != null) {
                  if (var5 != null && var5 != IsoDirections.Max && var5 != this._mannequin.dir) {
                     this._mannequin.dir = var5;
