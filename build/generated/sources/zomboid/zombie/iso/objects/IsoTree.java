...
public class IsoTree extends IsoObject {
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      if (this.isHighlighted()) {
         ...
         if (!this.bRenderFlag && !(this.fadeAlpha < this.targetAlpha[var8])) {
            ...
            float var9;
            if (!this.bRenderFlag) {
               var9 = this.targetAlpha[var8];
               if (this.fadeAlpha < var9) {
                  this.fadeAlpha += IsoObject.alphaStep;
                  if (this.fadeAlpha > var9) {
                     this.fadeAlpha = var9;
                  }
            ...
            var9 = this.alpha[var8];
            float var10 = this.targetAlpha[var8];
            this.alpha[var8] = this.fadeAlpha;
            this.targetAlpha[var8] = this.fadeAlpha;
            IndieGL.glStencilFunc(514, 128, 128);
            this.renderInner(var1, var2, var3, var4, true, false);
            this.alpha[var8] = var9;
            this.targetAlpha[var8] = var10;
   ...
   private void renderInner(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6) {
      ...
      if (var6 && this.sprite != null) {
         Texture var11 = this.sprite.getTextureForCurrentFrame(this.dir);
         if (var11 != null) {
            IsoTree.TreeShader.instance.setStepSize(0.25F, var11.getWidth(), var11.getHeight());
         }
      }

      super.render(var1, var2, var3, var4, false, false, (Shader)null);
      if (this.AttachedAnimSprite != null) {
         int var12 = this.AttachedAnimSprite.size();

         for(int var13 = 0; var13 < var12; ++var13) {
            IsoSpriteInstance var9 = (IsoSpriteInstance)this.AttachedAnimSprite.get(var13);
            float var10 = this.targetAlpha[IsoCamera.frameState.playerIndex];
            ...
            this.targetAlpha[IsoCamera.frameState.playerIndex] = var10;
            var9.update();
         }
      }
