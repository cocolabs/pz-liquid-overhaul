   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if (this.square != null) {
         ...
         if (var3 != null && this.lightRoom) {
            ...
            int var7 = 8;
            if (this.sprite.getProperties().Is("LightRadius") && Integer.parseInt(this.sprite.getProperties().Val("LightRadius")) > 0) {
               var7 = Integer.parseInt(this.sprite.getProperties().Val("LightRadius"));
            }

            IsoLightSource var8 = new IsoLightSource((int)this.getX(), (int)this.getY(), (int)this.getZ(), var4, var5, var6, var7);
            var8.bActive = this.Activated;
            var8.bWasActive = var8.bActive;
            var8.bHydroPowered = true;
            var8.switches.add(this);
            this.lights.add(var8);
         }
