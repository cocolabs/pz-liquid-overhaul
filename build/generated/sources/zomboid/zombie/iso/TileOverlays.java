...
public class TileOverlays {
   ...
   public void addOverlays(KahluaTableImpl var1) {
      ...
      while(true) {
         ...
         while(var6.advance()) {
            ...
            while(var10.advance()) {
               var8.tiles.add(var10.getValue().toString());
            }
   ...
   public void updateTileOverlaySprite(IsoObject var1) {
      if (var1 != null) {
         ...
         if (var2 != null) {
            ...
            if (!StringUtils.isNullOrWhitespace(var3) && Texture.getSharedTexture(var3) == null) {
               var3 = null;
            }
   ...
   private static final class TileOverlayEntry {
      ...
      public final TileOverlays.TileOverlayUsage usage;

      private TileOverlayEntry() {
         this.tiles = new ArrayList();
         this.usage = new TileOverlays.TileOverlayUsage();
      }
