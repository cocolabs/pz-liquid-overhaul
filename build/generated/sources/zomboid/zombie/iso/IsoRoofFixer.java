         ...
         if (var3 == 0) {
            ...
            for(int var13 = 0; var13 < var3; ++var13) {
               ...
               for(int var14 = var2.x - 3; var14 <= var2.x + 3; ++var14) {
                  for(int var9 = var2.y - 3; var9 <= var2.y + 3; ++var9) {
                     if (var14 != var2.x || var9 != var2.y) {
                        IsoGridSquare var10 = var1.getGridSquare(var14, var9, var2.z);
                        if (var10 != null) {
                           for(int var11 = 0; var11 < var10.getObjects().size(); ++var11) {
                              var6 = (IsoObject)var10.getObjects().get(var11);
                              if (isObjectRoofNonFlat(var6)) {
                                 setRoofTileCache(var6);
                                 return var2;
                              }
                           }

                           IsoGridSquare var15 = var1.getGridSquare(var10.x, var10.y, var10.z + 1);
                           if (var15 != null && var15.getObjects().size() > 0) {
                              for(int var12 = 0; var12 < var15.getObjects().size(); ++var12) {
                                 var6 = (IsoObject)var15.getObjects().get(var12);
                                 if (isObjectRoofFlatFloor(var6)) {
                                    setRoofTileCache(var6);
                                    return var2;
                                 }
                              }
