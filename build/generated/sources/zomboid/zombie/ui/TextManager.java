...
public final class TextManager {
   ...
   public void Init() throws FileNotFoundException {
      ...
      UIFont[] var7 = UIFont.values();
      int var8 = var7.length;

      for(int var9 = 0; var9 < var8; ++var9) {
         UIFont var10 = var7[var9];
         FontsFileFont var11 = (FontsFileFont)var3.get(var10.name());
         if (var11 == null) {
            DebugLog.General.warn("font \"%s\" not found in fonts.txt", var10.name());
         } else {
            ...
            if (var5.get(var14) != null) {
               this.enumToFont[var10.ordinal()] = (AngelCodeFont)var5.get(var14);
            } else {
               AngelCodeFont var15 = new AngelCodeFont(var12, var13);
               this.enumToFont[var10.ordinal()] = var15;
      ...
      try {
         ...
         String var19 = (new File("")).getAbsolutePath().replaceAll("\\\\", "/");
         String var21 = var19 + "/media/fonts/zomboidSmall.fnt";
         String var22 = var19 + "/media/fonts/zomboidSmall_0.png";
         if (var21.startsWith("/")) {
            var21 = "/" + var21;
         }

         this.enumToFont[UIFont.DebugConsole.ordinal()] = new AngelCodeFont(var21, var22);
      } finally {
         ZomboidFileSystem.instance.IgnoreActiveFileMap = false;
      }

      for(int var20 = 0; var20 < this.normal.length; ++var20) {
         this.normal[var20] = new AngelCodeFont("media/fonts/zomboidNormal" + (var20 + 11) + ".fnt", "media/fonts/zomboidNormal" + (var20 + 11) + "_0");
      }
