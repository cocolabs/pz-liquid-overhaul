...
public class UIElement {
   ...
   public void DrawTextureAngle(Texture var1, double var2, double var4, double var6) {
      if (this.isVisible()) {
         ...
         SpriteRenderer.instance.render(var1, var24, var26, var28, var30, var32, var34, var36, var38, var8, var9, var10, var11, var8, var9, var10, var11, var8, var9, var10, var11, var8, var9, var10, var11, (Consumer)null);
      }
   }
         ...
         if (this.isVisible()) {
            if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
               ...
               if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
                  ...
                  Double var8 = -this.getXScroll();
                  Double var9 = -this.getYScroll();
                  double var3 = 1.0D;
                  if (this.isMouseOver()) {
                     var3 = 0.0D;
                  }
                  ...
                  this.DrawTextureScaledColor((Texture)null, var8, var9, 1.0D, var5, var3, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var8 + 1.0D, var9, (double)this.width - 2.0D, 1.0D, var3, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var8 + (double)this.width - 1.0D, var9, 1.0D, var5, var3, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var8 + 1.0D, var9 + var5 - 1.0D, (double)this.width - 2.0D, 1.0D, var3, 1.0D, 1.0D, 0.5D);
               }
