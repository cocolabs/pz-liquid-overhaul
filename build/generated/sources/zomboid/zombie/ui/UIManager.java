   ...
   public static void init() {
      ...
      if (IsoPlayer.getInstance() != null) {
         ...
         if (!GameServer.bServer) {
            ...
            if (Core.bDebug && DebugOptions.instance.UIDebugConsole.getValue()) {
   ...
   public static void update() {
      if (!bSuspend) {
         ...
         for(var9 = 0; var9 < tutorialStack.size(); ++var9) {
            ...
            UI.add(0, tutorialStack.get(var9));
         }
         ...
         if (Mouse.isLeftPressed()) {
            ...
            if (Picked != null && Picked.tile != null && !var2) {
               LuaEventManager.triggerEvent("OnObjectLeftMouseButtonDown", Picked.tile, var5, var6);
            }

            if (!var2) {
               LuaEventManager.triggerEvent("OnMouseDown", var5, var6);
               CloseContainers();
         ...
         if (Mouse.isLeftReleased()) {
            ...
            if (!var18) {
               LuaEventManager.triggerEvent("OnMouseUp", var5, var6);
               if (Picked != null && Picked.tile != null && !var2) {
                  LuaEventManager.triggerEvent("OnObjectLeftMouseButtonUp", Picked.tile, var5, var6);
               }
            }
         }
         ...
         if (Mouse.isRightPressed()) {
            ...
            if (!var3) {
               LuaEventManager.triggerEvent("OnRightMouseDown", var5, var6);
               if (Picked != null && Picked.tile != null && !var3) {
                  LuaEventManager.triggerEvent("OnObjectRightMouseButtonDown", Picked.tile, var5, var6);
               }
            } else {
         ...
         if (Mouse.isRightReleased()) {
            ...
            if (!var15) {
               LuaEventManager.triggerEvent("OnRightMouseUp", var5, var6);
               if (Picked != null && Picked.tile != null) {
                  ...
                  if (var17) {
                     LuaEventManager.triggerEvent("OnObjectRightMouseButtonUp", Picked.tile, var5, var6);
                  }
               }
            }
         ...
         handleZoomKeys();
         IsoCamera.cameras[0].lastOffX = IsoCamera.cameras[0].OffX;
         IsoCamera.cameras[0].lastOffY = IsoCamera.cameras[0].OffY;
      }
   }
