   ...
   public void render() {
      if (this.isVisible()) {
         ...
         if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
            Double var3 = -this.getXScroll();
            Double var4 = -this.getYScroll();
            this.DrawTextureScaledColor((Texture)null, var3, var4, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var3 + 1.0D, var4, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var3 + (double)this.width - 1.0D, var4, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var3 + 1.0D, var4 + (double)this.height - 1.0D, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
         }
