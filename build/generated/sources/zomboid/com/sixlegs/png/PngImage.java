            ...
            for(HashSet var7 = new HashSet(); var5.getState() != 6; var6.endChunk(var19)) {
               ...
               try {
                  ...
                  if (!this.isMultipleOK(var19) && !var7.add(Integers.valueOf(var19))) {
                     throw new PngException("Multiple " + PngConstants.getChunkName(var19) + " chunks are not allowed", !PngConstants.isAncillary(var19));
                  }
                  ...
                  try {
                     ...
                     throw new PngException("Malformed " + PngConstants.getChunkName(var19) + " chunk", var16, !PngConstants.isAncillary(var19));
                  }
