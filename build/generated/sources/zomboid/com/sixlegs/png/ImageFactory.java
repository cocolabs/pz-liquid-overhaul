...
class ImageFactory {
   ...
   public static BufferedImage createImage(PngImage var0, InputStream var1, Dimension var2) throws IOException {
      ...
      Object var25 = null;
      if (!var9) {
         int[] var26 = (int[])((int[])var0.getProperty("transparency", int[].class, false));
   ...
   private static ColorModel createColorModel(PngImage var0, short[] var1, boolean var2) throws PngException {
      ...
      if (isIndexed(var0) && !var2) {
         ...
         int var17;
         if (var4 == 3) {
            var10 = (byte[])((byte[])var0.getProperty("palette", byte[].class, true));
         ...
         if (var3.containsKey("palette_alpha")) {
            var10 = (byte[])((byte[])var0.getProperty("palette_alpha", byte[].class, true));
            ...
            if (var3.containsKey("transparency")) {
               var17 = ((int[])((int[])var0.getProperty("transparency", int[].class, true)))[0];
            }
