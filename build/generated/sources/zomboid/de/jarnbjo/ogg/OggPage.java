   ...
   private static OggPage create(Object var0, boolean var1) throws IOException, EndOfOggStreamException, OggFormatException {
      try {
         ...
         if (var0 instanceof RandomAccessFile) {
            ...
            System.arraycopy((byte[])((byte[])var0), 0, var3, 0, 27);
         }
         ...
         if (var5 != 1399285583) {
            ...
            var6 = var6.substring(6, 8) + var6.substring(4, 6) + var6.substring(2, 4) + var6.substring(0, 2);
         ...
         for(int var22 = 0; var22 < var16; ++var22) {
            ...
            if (var0 instanceof RandomAccessFile) {
               ...
               byte var32 = ((byte[])((byte[])var0))[var2++];
               var23 = var32 & 255;
            }
         ...
         byte[] var31 = null;
         if (!var1) {
            var31 = new byte[var19];
            if (var0 instanceof RandomAccessFile) {
               ((RandomAccessFile)var0).readFully(var31);
            } else if (var0 instanceof InputStream) {
               readFully((InputStream)var0, var31);
            } else if (var0 instanceof byte[]) {
               System.arraycopy(var0, var2, var31, 0, var19);
            }
         }

         return new OggPage(var26, var28, var29, var30, var11, var13, var14, var15, var17, var18, var19, var3, var20, var31);
