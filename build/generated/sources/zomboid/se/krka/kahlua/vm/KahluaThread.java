         ...
         try {
            ...
            case 17:
               ...
               if ((var75 = KahluaUtil.rawTonumber(var38)) != null && (var46 = KahluaUtil.rawTonumber(var48)) != null) {
                  ...
                  String var63 = meta_ops[var14];
                  var64 = this.getBinMetaOp(var38, var48, var63);
                  if (var64 == null) {
                     this.doStacktraceProper(var1);
                     String var62 = "unknown";
                     if (var2.debugName != null) {
                        var62 = var2.debugName;
                     } else if (var3.name != null) {
                        var62 = var3.name;
                     }

                     KahluaUtil.fail(var63 + " not defined for operands in " + var62);
                  }
