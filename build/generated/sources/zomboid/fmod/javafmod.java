...
public class javafmod {
   ...
   public static int FMOD_System_GetSoundRAM(SWIGTYPE_p_FMOD_SYSTEM var0, SWIGTYPE_p_int var1, SWIGTYPE_p_int var2, SWIGTYPE_p_int var3) {
      return javafmodJNI.FMOD_System_GetSoundRAM(SWIGTYPE_p_FMOD_SYSTEM.getCPtr(var0), SWIGTYPE_p_int.getCPtr(var1), SWIGTYPE_p_int.getCPtr(var2), SWIGTYPE_p_int.getCPtr(var3));
   }
   ...
   public static void FMOD_Studio_LoadSampleData(long var0) {
      javafmodJNI.FMOD_Studio_LoadSampleData(var0);
   }
   ...
   public static int FMOD_Channel_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNEL var0, SWIGTYPE_p_FMOD_VECTOR var1, SWIGTYPE_p_FMOD_VECTOR var2, SWIGTYPE_p_FMOD_VECTOR var3) {
      return javafmodJNI.FMOD_Channel_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNEL.getCPtr(var0), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var1), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var2), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var3));
   }
   ...
   public static int FMOD_ChannelGroup_Set3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP var0, SWIGTYPE_p_FMOD_VECTOR var1, SWIGTYPE_p_FMOD_VECTOR var2, SWIGTYPE_p_FMOD_VECTOR var3) {
      return javafmodJNI.FMOD_ChannelGroup_Set3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP.getCPtr(var0), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var1), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var2), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var3));
   }

   public static int FMOD_ChannelGroup_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP var0, SWIGTYPE_p_FMOD_VECTOR var1, SWIGTYPE_p_FMOD_VECTOR var2, SWIGTYPE_p_FMOD_VECTOR var3) {
      return javafmodJNI.FMOD_ChannelGroup_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP.getCPtr(var0), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var1), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var2), SWIGTYPE_p_FMOD_VECTOR.getCPtr(var3));
   }
   ...
   public static int FMOD_Studio_SetParameter(long var0, String var2, float var3) {
      return javafmodJNI.FMOD_Studio_SetParameter(var0, var2, var3);
   }
   ...
   public static int FMOD_Studio_SetVolume(long var0, float var2) {
   ...
   public static int FMOD_Studio_StopInstance(long var0) {
      return javafmodJNI.FMOD_Studio_StopInstance(var0);
   }
}
