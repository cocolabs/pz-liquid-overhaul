...
function ISAlarmClockDialog:initialise()
    ...
    self.button1p = ISButton:new((self:getWidth() / 2) - 28, buttonsY, 25, btnUpDownHgt, "^", self, ISAlarmClockDialog.onClick);
    ...
    self.hours = ISTextEntryBox:new("0", self:getWidth() / 2 - 28, self.button1p:getBottom() + 2, 25, entryHgt);
    self.hours:initialise();
    self.hours:instantiate();
    self:addChild(self.hours);

    self.button1m = ISButton:new(self:getWidth() / 2 - 28, self.hours:getBottom() + 2, 25, btnUpDownHgt, "v", self, ISAlarmClockDialog.onClick);
    ...
    --
    self.button2p = ISButton:new(self:getWidth() / 2 -1, buttonsY, 25, btnUpDownHgt, "^", self, ISAlarmClockDialog.onClick);
    ...
    self.mins = ISTextEntryBox:new("0", self:getWidth() / 2 -1, self.button2p:getBottom() + 2, 25, entryHgt);
    self.mins:initialise();
    self.mins:instantiate();
    self:addChild(self.mins);

    self.button2m = ISButton:new(self:getWidth() / 2 -1, self.mins:getBottom() + 2, 25, btnUpDownHgt,"v", self, ISAlarmClockDialog.onClick);
