...
function ShotgunStep.BackOverFence()
    ...
    local complete = ShotgunStep.vaulted and getPlayer():getCurrentSquare():getY() == 153 and getPlayer():getCurrentState():equals(IdleState.instance());
    if complete then
        SneakStep.setZoom(1.5);
...
--    end
    ...
    local complete = ShotgunStep.vaulted and getPlayer():getCurrentSquare():getY() == 152 and getPlayer():getCurrentState():equals(IdleState.instance());
    if complete then
        getPlayer():setIgnoreContextKey(true);
        getPlayer():setSneaking(false);
        for x,v in ipairs(ShotgunStep.squares) do
