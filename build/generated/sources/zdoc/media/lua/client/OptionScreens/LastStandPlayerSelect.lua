		...
		for i=0,playerList:size()-1 do
			...
			while true do
				...
				if luautils.stringStarts(line, "Visual=") then
					newPlayer.humanVisual = string.sub(line, 8)
				end
				...
				if luautils.stringStarts(line, "clothing=") then
					newPlayer.clothingVisuals = newPlayer.clothingVisuals or {}
					table.insert(newPlayer.clothingVisuals, string.sub(line, 10))
				end
				...
				if luautils.stringStarts(line, "addSkills") then
					...
					newPlayer.skills[perkName] = level;
				end
