...
---@field public NetRemoteState byte
...
---@field private hitBy IsoGameCharacter
...
---@field remoteMoveX float
---@field remoteMoveY float
---@field isNPC boolean
...
---@field private attackingZombie IsoZombie
